...
translate malay strings:
    ...
    new "Terima kasih bermain permainan ini!"

    # game/code/credit_sprites.rpy:8
    old "We'll see you in Week Three!"
    new "Jumpa lagi pada Minggu Ketiga!"
