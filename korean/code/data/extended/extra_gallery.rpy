...
translate korean strings:
    ...
    new "민의 파티에서 데이지와 할 수 있는 모든 일을 다 한다"
    ...
    new "민의 파티에서 가능한 모든 방법으로 본 행사를 마무리 한다"
    ...
    new "한 번의 플레이에서 두 번의 신속 도전을 발동한다"
    ...
    # game/code/data/extended/extra_gallery.rpy:15
    old "How’s that work?!"
    new "어떻게 그런 일이 가능한 거야?!"

    # game/code/data/extended/extra_gallery.rpy:15
    old "Deflower Cynthia's freshly renovated garden"
    new "새것처럼 돌아온 신시아의 정원에서 꽃을 뽑는다"
    ...
    new "한 번이 플레이에서 가능한 모든 사람과 함께한다"
    ...
    new "한 주가 끝날 때까지 가장 적은 수의 사람과 함께한다"
