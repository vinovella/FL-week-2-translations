...
translate korean strings:
    ...
    new "[FLSS.week.prev]주차 페티시 로케이터 게임을 실행하고 최종 게임 저장 화면에서 게임을 저장하십시오"
    ...
    new "{b}도움말{/b} 메뉴에서 이 키 배치를 확인하실 수 있습니다"
    ...
    new "민을 선택하려면 뒤로 가서 {b}워터스포츠{/b} 성벽을 활성화 하십시오"
