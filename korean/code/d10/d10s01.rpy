...
translate korean d10s01_bd4abf4b:
    ...
    mct "그냥 피트 자식이 코 고는 소리잖아. {w}망할. 이 자식이 여기에서 자주 안 자니까 다행이지."

# game/code/d10/d10s01.rpy:19
translate korean d10s01_09e9fe23:
...
translate korean d10s01_7c834441:
    ...
    mct "리디아는 내가 다른 사람이랑 있길 바라니까. 이건 멋지긴 하지. 그런데, 아직도 여전히 이해를 못하겠어."
...
translate korean d10s01_a5e7c3dc:
    ...
    mct "리디아를 속이지 않아도 된다는 건 좋은 거야. 페티시 로케이터에 관한 일을 해야 하니까."
...
translate korean d10s01_833955e6:
    ...
    mct "재미도 많이 보고 있고. 게다가 이 앱이 내 성 생활에 엄청 도움도 되니까."
...
translate korean d10s01_d49216cf:
    ...
    mct "아니면 닥터 스트레인지 러브나. 내가 정말로 이 페티시 로케이터라는 폭탄을 사랑하는 법을 배워야 하는 걸까?"
...
translate korean d10s01_cc523925:
    ...
    mct "너무 깊게 생각하는 건 그만 두고, 그냥 계속 해야 돼."
...
translate korean d10s01_e4dcf492:
    ...
    mct "피트는 완전히 실신 상태구만. {w}바로 옆에서 하는 건 바보 같은 짓이긴 하지만, 우연이라도 내가 뭘 했는지 눈치는 못 채겠지."
...
translate korean d10s01_c4040c42:
    ...
    mct "다른 비밀번호로 해 볼까. 흐음... 유령0613. 이건 최소한 진짜 비밀번호 같네."
