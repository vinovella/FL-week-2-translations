...
translate korean d09s08_339cfe9f:
...
translate korean d09s08_8cc631b8:
    ...
    lc "사회학 필기 복습을 마치니까 네 목소리가 듣고 싶더라. 그런데 이렇게 듣게 됐네."
...
translate korean d09s08_9cabba75:
    ...
    lc "아, 그런데 난 네 생각만 했지. 사실 네 말을 한 적은 없는데."
...
translate korean d09s08_eafe110a:

    # lc "What's up?"
    lc "무슨 일이야?"

# game/code/d09/d09s08.rpy:34
translate korean d09s08_6bf95e6e:

    # mc "Can you hold on a second? I've got another call."
    mc "잠깐만 기다려 줄 수 있어? 다른 전화가 와서."

# game/code/d09/d09s08.rpy:35
translate korean d09s08_c117bfaa:

    # lc "Of course."
    lc "물론이지."

# game/code/d09/d09s08.rpy:36
translate korean d09s08_fa45f281:

    # mc "Thanks..."
    mc "고마워..."

# game/code/d09/d09s08.rpy:39
translate korean d09s08_9fcec11d:
...
translate korean d09s08_f6fcd500:
    ...
    mc "네 목소리를 듣는데 늦을 땐 없지만, 지금 다른 사람이랑 통화 중이였어."
...
translate korean d09s08_863cf98e_1:
    ...
    # vw "I thought you'd want to know asap. The apartment is ready."
    vw "바로 알고 싶어할 만한 소식이라고 생각해서요. 아파트 준비됐어요."

# game/code/d09/d09s08.rpy:108
translate korean d09s08_069ec8d2_1:

    # mc "The apartment? {w}Oh! Stacy's apartment. That's terrific!"
    mc "아파트요? {w}아! 스테이시의 아파트. 훌륭하네요!"

# game/code/d09/d09s08.rpy:109
translate korean d09s08_da92c621_1:

    # vw "I'll text you the info. Ms. Harris will be ready with the keys and the contract anytime tomorrow."
    vw "관련 사항은 문자로 보낼게요. 내일은 언제든지 해리스 양이 열쇠와 계약서를 준비할 수 있어요."
...
translate korean d09s08_24b24091:
    ...
    mc "해리스 양?{w} 아, 맞다. 리사. 미안해요, 좀 피곤해서 말실수를 했네요."
...
translate korean d09s08_30e4d590:
    ...
    vw "아까 말씀드린 대로. 모든 사항은 문자로 보낼게요. 좋은 밤 되시고 좋은 꿈 꾸세요."
...
translate korean d09s08_49c92780:

    # mc "Wait - are they actually on a World Tour?"
    mc "잠깐만. 정말로 공연을 하러 세계를 돌아다니시는 거야?"
...
translate korean d09s08_14ae7c06:
    ...
    mc "대단하네. 난 핀란드는 가 본 적도 없는데."

# game/code/d09/d09s08.rpy:142
translate korean d09s08_0f964681:

    # lc "So... {w}about tomorrow. Do you mind if we discuss the Party?"
    lc "그렇지... {w}내일에 관해서 말인데. 파티에 관해서 이야기해도 될까?"
...
translate korean d09s08_11a09cb2:
    ...
    lc "쉽게 가자. 어젯밤에 네 섹스 이야기 듣는 거 좋았어."

# game/code/d09/d09s08.rpy:150
translate korean d09s08_a31340dd:
...
translate korean d09s08_fccb439d:
    ...
    lc "정말. 좋았어... 너한테 여러 섹스 이야기를 듣고 있으니 정말 좋았어."
...
translate korean d09s08_cdacf4f7:
    ...
    lc "네가 한 일을 듣는 거 좋아. {w}너랑 한 사람에 관해서 듣는 것도 좋고."
...
translate korean d09s08_17d56721:
    ...
    lc "하지만 네가 누구랑 뭘 할지 생각하면서 내일 저녁을 보내고 싶진 않아."
...
translate korean d09s08_ae6abb16:
    ...
    lc "이상하지. 나도 알아. 나 스스로도 왜 이런 생각이 드는지 파악하려고 하고 있어."
...
translate korean d09s08_f46c00b3:
    ...
    lc "이렇게 말해 보자. 네가 모르는 여자를 낚을 거라는 사실을 알게 되면, 화가 날 거야."
...
translate korean d09s08_d4059a9e:
...
translate korean d09s08_b9a4278a:
    ...
    mc "내가 한 일을 듣는 건 좋지만, 내가 무슨 일을 할 거라는 건 듣고 싶어하지 않는 거야."
...
translate korean d09s08_6a189cd4:
    ...
    mc "설명할 게. 난 내일 파티에 가지 않을 거지만. 목요일 밤에 우리가 이야길 하긴 전까진 파티에 갔을 거야."
...
translate korean d09s08_63de190a:

    # mct "Is this completely crazy or totally awesome?"
    mct "이게 완전히 미친 소리야, 아니면 끝내주게 멋진 일이야?"
