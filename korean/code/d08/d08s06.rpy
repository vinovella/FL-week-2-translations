...
translate korean d08s06_ac74a996:
    ...
    sa "내가 앨리슨은 일찍 만났다면, 그렇게 됐겠지. 그래도, 주나 지역 기록은 세울 수도 있어..."
...
translate korean d08s06_5a122a58:
    ...
    sy "어제도 이겼는데요. 카약 경기에 나온 사람 전부 다 날려 버렸다구요."
...
translate korean d08s06_7feb5c0d:
    ...
    sa "그건 이긴 게 아냐. 그 대학 애들 상대하는 건 애들 장난이지."
...
translate korean d08s06_c22ce67f:
    ...
    sa "오해하진 마. 맞춤법 같은 걸로 붙는 거면 대학 애들이 우릴 이길 수도 있겠지만, 운동이라면?"
...
translate korean d08s06_4cd714a8:
    ...
    sa "어제 앨리슨은 진심으로 시합을 뛴 게 아냐. 그냥 \"재미를 본\" 거지."
...
translate korean d08s06_ab8112cc:
    ...
    sy "재미 보는 게 나쁜 거예요? 신성 모독 같이 말씀하시네요."
...
translate korean d08s06_f50f4a6c:
    ...
    mc "앨리슨 정도의 재능이라면, 최선을 다 할 의무가 있다는 말씀이신가 본데."
...
translate korean d08s06_94010d91:
    ...
    mc "아뇨, 경영학 전공하는 학생이에요. 그냥 생각나는 대로 말한 거 뿐이구요."
...
translate korean d08s06_560334a0:
    ...
    sa "미꾸라지 같은 자식인데, 응? 경영학 전공하는 애들은 다 너 같은 놈들이냐?"
...
translate korean d08s06_251e0c2a:
    ...
    sa "내가 앨리슨 훈련을 방해할 순 없어. 이미 일정을 지키게 하는 걸로도 어려운 상태니까."
...
translate korean d08s06_258e9ff8:
    ...
    sa "아, 좋겠지, 어쨌든 너희도 알 테니까. 앨리슨의 수업 같은 건 오늘 오후 4시에 마무리가 될 거다."
