...
translate russian prologue_fresh_start_56a763ee:
    ...
    "Сейчас игра задаст несколько вопросов и настроит твой профиль.\nДля получения лучшего результата, мы приглашаем тебя самостоятельно сыграть в первую неделю Фетиш Локатора."
...
translate russian prologue_girls_set_1_3502c4fc:
    ...
    "В первую неделю ты познакомился с несколькими красивыми девушками: Некоторые из них могут быть полезными или даже потенциальными любовными интересами.\nНажми на их портреты, чтобы выбрать. После завершения выбора нажми \"Принять\"."

# game/code/d08/prologue.rpy:138
...
# game/code/d08/prologue.rpy:145
...
# game/code/d08/prologue.rpy:185
translate russian prologue_nora_creampie_fcd0a635:

    # "We see you like a little extra cream in your pie. Did you cum in Nora in Week One?"
    "Значит ты любишь побольше сливок в своем пироге? Ты кончил в Нору в первой неделе?"

# game/code/d08/prologue.rpy:204
translate russian prologue_finalize_b8dc714d:

    # "Great! You're now ready to begin your second week playing Fetish Locator!"
    "Отлично! Теперь мы готовы начать вторую неделю игры в Фетиш Локатор!"
...
translate russian strings:
    ...
    new "Как назовётесь в приложении Фетиш Локатора?\nЕсли оставить пустым, то игра будет добавлять \"Не_\" перед именем: Например Не_Майк"
    ...
    # game/code/d08/prologue.rpy:103
    ...
    # game/code/d08/prologue.rpy:146
    ...
    # game/code/d08/prologue.rpy:187
    old "Yes, I came in her and got thrown out"
    new "Да, я кончил в нее и меня выгнали."
