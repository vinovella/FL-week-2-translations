...
translate russian failed_mp_5d0c3fdc:
    ...
    "Ваше устройство не может передавать сохранение прогресса игры из разных недель.\nПожалуйста, позвольте ФЛ записаться на внешнем хранилище."
...
translate russian after_credits_6dc8b0bc:
    ...
    dd "Кого волнует каноны! Это же сцена после титров! Мы можем делать что захотим!"
...
translate russian after_credits_9e887ff2:
    ...
    "{color=#ba50f3}Неизвестная Девушка 2{/color}" "Кто там?"
...
translate russian after_credits_f940c803:
    ...
    "{color=#ba50f3}Неизвестная Девушка 2{/color}" "С кем ты разговариваешь?"
...
translate russian after_credits_2d991197:
    ...
    "{color=#f93737}Неизвестная Девушка 1{/color}" "Детишки из колледжа. Очевидно, они не умеют читать!"

# game/code/labels.rpy:216
...
translate russian after_credits_3e0c140e:
    ...
    "{color=#ba50f3}Неизвестная Девушка 2{/color}" "О Дейзи и Стейси!"

# game/code/labels.rpy:222
translate russian after_credits_2124ac9d:

    # "{color=#ba50f3}Unknown Girl 2{/color}" "You are early!"
    "{color=#ba50f3}Неизвестная Девушка 2{/color}" "Вы слишком рано пришли!"
...
translate russian after_credits_8e51ee0d:
    ...
    "{color=#ec8664}Неизвестная Девушка 3{/color}" "Девочки! С кем вы разговариваете??"

# game/code/labels.rpy:230
translate russian after_credits_7e6fe4d2:

    # "{color=#ba50f3}Unknown Girl 2{/color}" "They opened the door..."
    "{color=#ba50f3}Неизвестная Девушка 2{/color}" "Они открыли дверь..."
...
translate russian after_credits_ec4dc5c9:
    ...
    "{color=#ec8664}Неизвестная Девушка 3{/color}" "Эй! Сейчас не самое подходящее время! Мы еще не готовы!"
...
translate russian after_credits_e29ad5fa:
    ...
    "{color=#ec8664}Неизвестная Девушка 3{/color}" "Земфира! Это не тот наряд! Глава 4 Сцена 5 - это не сексуальная сцена! Что на тебе надето??"
...
translate russian after_credits_b7af7f44:
    ...
    "{color=#ec8664}Неизвестная Девушка 3{/color}" "Скоро ты сможешь узнать о нас больше."

# game/code/labels.rpy:259
translate russian after_credits_4244eb77:

    # sy "Give us something! I'm dying from curiosity!"
    sy "Дай нам хоть что-нибудь! Я умираю от любопытства!"

# game/code/labels.rpy:262
translate russian after_credits_db5b7cd2:
    ...
    "{color=#ba50f3}Неизвестная Девушка 2{/color}" "Поддержи команду ViNovella, чтобы они могли продолжить рассказывать наши истории!"
...
translate russian after_credits_f5cfef90:
    ...
    sy "Но это было грандиозно! Ты знаешь, что это может означать?!"
...
translate russian after_credits_dc4bfcb4:
    ...
    dd "Не совсем... Мы вышли за рамки сценария, канона и временной шкалы."

# game/code/labels.rpy:287
translate russian after_credits_ea09095a:

    # dd "There are no consequences here! Let's just have sex, Stacy!"
    dd "Здесь нет никаких последствий! Давай займемся сексом, Стейси!"

# game/code/labels.rpy:290
translate russian after_credits_395b12fe:

    # sy "Fuck Yeah!"
    sy "Да, черт возьми!"

# game/code/labels.rpy:294
