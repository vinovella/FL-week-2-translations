...
translate russian strings:
    ...
    # game/code/screens/screens_fl.rpy:92
    old "SAVE"
    new "СОХРАНИТЬ"
...
translate russian strings:
    ...
    new "Не обнаружено сохранение игры с недели [FLSS.week.prev]"
    ...
    new "Пожалуйста, СОХРАНИТЕСЬ в конце недели [FLSS.week.prev], на экране сохранения игры"
