...
translate french d13s07_0bfdab73:
    ...
    mc "Whoa!{w} Salut Min.{w}.. Lydia m'a dit que je devrais de voir?"
...
translate french d13s07_bdd1185f:
    ...
    mes "Ouais, elle veut qu'on sorte et qu'on passe un bon moment, qu'on apprenne à se connaître..."

# game/code/d13/d13s07.rpy:28
translate french d13s07_dc2969da:

    # mc "And to distract you from your recent breakup?"
    mc "Et pour oublier ta récente rupture ?"
...
translate french d13s07_2770918a:
    ...
    mes "Exactement. Mais c'est bizarre d'aller à un rendez-vous avec son petit ami."
...
translate french d13s07_3abad34e:
    ...
    mc "Eh bien, elle aime être avec moi. Donc, elle pense probablement que toi aussi."
...
translate french d13s07_c6c60251:
    ...
    mes "Lydia M’a dit que tu avais des histoires amusantes au sujet de ton emploi d'été ?"
...
translate french d13s07_aab0190d:
    ...
    mc "Oh, oui. Pendant l'été j'ai travaillé dans une agence de voyage."

# game/code/d13/d13s07.rpy:86
translate french d13s07_d0c5822b:

    # mes "You were a travel agent?"
    mes "Tu étais agent de voyages ?"
...
translate french d13s07_4d52d75a:
    ...
    mc "Tout comme. Je n'avais ni permis ni autorisations et j'étais payé au noir."

# game/code/d13/d13s07.rpy:90
translate french d13s07_44da5aea:

    # mc "But otherwise I did everything a travel agent does."
    mc "Mais sinon, je faisais tout ce qu’un agent de voyages faisait."
...
translate french d13s07_721ace72:
    ...
    mes "Donc, tu as fait partie d'une agence de voyages illégale ?"
...
translate french d13s07_a8d213b5:
    ...
    mc "Il y avait un agent agréé, donc tous les documents portaient officiellement son nom, mais...{w} ouais, un peu."

# game/code/d13/d13s07.rpy:99
translate french d13s07_9d32811d:

    # mes "Weird, but sounds like fun."
    mes "Bizarre, mais ça a l'air amusant."
...
translate french d13s07_4caf7c91:
    ...
    mc "Ça l'était. {w}Un jour, j'étais en train de fermer le bureau quand j'ai reçu un appel de deux jeunes mariés..."
...
translate french d13s07_e1a2d0d7:
    ...
    mc "Ils étaient en pleine lune de miel et leur hôtel était surbooké."
...
translate french d13s07_30e11b22:
    ...
    mc "Ouais... {w}S'ils avaient réservé leurs billets via Internet, ils n'auraient pas eu de chance, mais à la place, ils m'ont appelé."

# game/code/d13/d13s07.rpy:112
translate french d13s07_0a1fad7c:

    # mes "What do you even do in a situation like that?"
    mes "Que faites-vous dans une situation comme celle-ci ?"
...
translate french d13s07_6301fd94:
    ...
    mc "Tout d'abord, je leur ai offert un verre au bar pour qu'ils puissent se détendre et commencer leur lune de miel."
...
translate french d13s07_467ec2b2:
    ...
    mc "Pendant qu'ils buvaient, j'ai convaincu le directeur de leur offrir un surclassement dans la suite nuptiale."

# game/code/d13/d13s07.rpy:119
translate french d13s07_0ca5f8a8:

    # mes "How did you do that?"
    mes "Comment tu as fait?"
...
translate french d13s07_c92f1c01:
    ...
    mc "Il était clair que le réceptionniste et le directeur cherchaient des pots-de-vin, mais ils avaient royalement foiré."
...
translate french d13s07_f7adbeb5:
    ...
    mc "J'ai raconté au manager cette histoire de jeunes mariés extorqués pendant leur lune de miel, Nommé quelques magazines de voyage qui pourraient raconter l'histoire, puis je lui ai donné une porte de sortie."
...
translate french d13s07_d15bb3e3:
    ...
    mc "Les surclasser et, en échange, je parlais à son patron de la manière dont il a géré cette situation délicate avec habileté et responsabilité."
...
translate french d13s07_bd1bfdd2:
    ...
    mes "Ha! Il a eu son pot de vin finalement - et c'est même pas toi qui l'a donné."
...
translate french d13s07_eaf6f616:
    ...
    mc "Le couple a passé une lune de miel fantastique et a envoyé des fleurs à notre bureau à leur retour."
...
translate french d13s07_11361ca4:
    ...
    mes "Bien joué. {w}Mon été n'a pas été aussi intéressant."
...
translate french d13s07_95fa6ed2:
    ...
    mes "Un stage dans l'entreprise de mon père. C'est un bon entraînement si je décide d'y travailler, mais ce n'est pas très intéressant ou passionnant. Je ne suis pas sûre de vouloir faire ça."
...
translate french d13s07_7655a7cb:
    ...
    mc "Qu'est-ce que tu aimerais faire ? Tu es étudiante en gestion d'entreprise comme moi, n'est-ce pas ?"
...
translate french d13s07_7975ceee:
    ...
    mes "Ça et en économie. J'ai pensé à créer ma propre entreprise, à devenir PDG et à essayer de construire quelque chose à partir de zéro."
...
translate french d13s07_775894b2:
    ...
    mc "Ça a l'air super. J'adorerais essayer quelque chose de similaire. Démarrer une petite entreprise et lutter pour réussir. Ça pourrait être très enrichissant."
...
translate french d13s07_5d6c6c50:
    ...
    mes "Je ne suis pas si sûre pour une petite entreprise. Trop de stress pour trop peu de récompenses. Je pensais à une filiale directe de la société de mon père."
...
translate french d13s07_1d9b0934:
    ...
    mc "Un plus grand risque ; une plus grande récompense. Quel genre d’entreprise tu as en tête ?"
...
translate french d13s07_704737bb:
    ...
    mes "Soit le trading à haute fréquence, soit les données sociodémographiques. Ce sont deux domaines prometteurs dotés d’un énorme potentiel."
...
translate french d13s07_d7ddaf18:
    ...
    mc "Le THF nécessite une quantité massive de capital pour gagner de l’argent sur les marges. Je suppose que tu envisages de commencer par l'autre ?"
...
translate french d13s07_b0f06054:
    ...
    mes "Exactement. Je ne pense pas que tu veuilles travailler pour moi après l'université. Je pourrais avoir besoin d'un directeur financier."
...
translate french d13s07_cb5aecd1:
    ...
    mc "C'est pas mon truc. Comme je l'ai dit, je suis plus intéressé par démarrer ma propre petite entreprise."
...
translate french d13s07_f7959eec:
    ...
    mes "Peut-être pourrais-tu créer ton propre studio porno. Tu sembles très intéressé par un certain nombre de femmes et de fétiches."
...
translate french d13s07_ee676f89:
    ...
    mc "Ce n'est pas une mauvaise idée. Je ne pense pas que tu voudrais être l'un de mes modèles."

# game/code/d13/d13s07.rpy:179
translate french d13s07_e21100ed:

    # mes "Only if there's some fierce competition."
    mes "Seulement s'il y a une concurrence féroce."
...
translate french d13s07_f8cab91e:
    ...
    mes "Il y a quelque chose que je ne comprends pas. {w}Tu dois baiser 20 personnes, non ?"

# game/code/d13/d13s07.rpy:183
translate french d13s07_1b83af3b:

    # mc "You heard about that?"
    mc "Oh, tu as entendu parler de ça ?"
...
translate french d13s07_d9c7a396:
    ...
    mes "Lydia m'a dit que c'était une sorte de défi personnel. {w}Je me suis dit qu'il s'agissait de Fetish Locator."

# game/code/d13/d13s07.rpy:189
translate french d13s07_03d8272c:

    # mc "Yeah, but don't say too much about that last part."
    mc "Ouais, mais n'en dis pas trop sur cette dernière partie."

# game/code/d13/d13s07.rpy:192
translate french d13s07_fd54ab48:

    # mes "You know that we could fuck and yet... here we are."
    mes "Tu sais qu'on pourrait baiser et pourtant... nous y voilà."
...
translate french d13s07_66d6ff5e:
    ...
    mes "Je ne comprends pas. {w}Tu sors avec Lydia, mais je sais que vous ne couchez pas enssemble."
...
translate french d13s07_9d62bd89:
    ...
    mc "Je ne le comprends pas entièrement moi-même{w}, mais j'en parlerai à Lydia demain et je trouverai une solution avec elle."

# game/code/d13/d13s07.rpy:217
translate french d13s07_426aee13:

    # mes "If you dump Lydia to date me I will never forgive you."
    mes "Si tu abandonnes Lydia pour sortir avec moi, je ne te le pardonnerai jamais."
...
translate french d13s07_27fe36b0:
    ...
    mes "C'est quand la date limite ?"
...
translate french d13s07_a5781116:
    ...
    mes "Non.{w} Tu ne cherches pas à me baiser ce soir, et j'apprécie ça - même si ça me rend complètement confuse."
...
translate french d13s07_e31f9b97:
    ...
    mes "Tu veux que ce soit juste un rendez-vous amical, et je peux comprendre."
...
translate french d13s07_5c489cf0:
    ...
    mes "Mais demain, on couche ensembles."
...
translate french d13s07_269bfef4:
    ...
    mes "Alors, laisse moi t'aider.{w} Où et quand ?"
...
translate french d13s07_3d38bd61:
    ...
    mc "Lydia t'as parlé du défi. T'as-t-elle aussi parlé de la fête ?"
...
translate french d13s07_8fb5588e:
    ...
    mc "J'organise une petite fête \"Baise avec moi\" à la maison de Lydia demain."
...
translate french d13s07_8fcf5f70:
    ...
    mes "Sérieux ? {w}Je veux dire, je savais qu'elle était cool avec ça...{w} mais chez elle ?"
...
translate french d13s07_ee5006ad:
    ...
    mc "Ouep. {w}Je ne suis pas sûr de tous les détails, mais il pourrait même y avoir un château gonflable."
...
translate french d13s07_62cfa725:
    ...
    mc "Oui. {w}Il n'y aura pas de château gonflable."
...
translate french d13s07_797fd5fa:
    ...
    mc "Une amie de chez moi. {w}Elle commence l'université ici à l'automne."
...
translate french d13s07_b0181984:
    ...
    mes "Hein. {w}Félicitations, tu as réussi à faire quelque chose qu'aucun professeur n'a jamais réalisé."
...
translate french d13s07_e7fa3421:
    ...
    mes "Tu m'as complètement perdue."
...
translate french d13s07_82b940ab:
    ...
    mc "Hey. Je sais que tu voulais...{w} tu sais, cette nuit."
...
translate french d13s07_86e9e8b6:
    ...
    mes "Ouais. À propos de ça. {w}Je ne sais pas si je le voulais, ou si je voulais juste que tu le veuilles."
...
translate french d13s07_635c46ab:
    ...
    mc "Aucun débat. J'ai envie de toi. {w}Je veux juste plus qu'une simple relation physique avec toi."

# game/code/d13/d13s07.rpy:353
translate french d13s07_c0892bbd:

    # mes "You'll talk to Lydia tomorrow?"
    mes "Tu parleras à Lydia demain ?"
