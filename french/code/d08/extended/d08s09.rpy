...
translate french d08s09_9959197d:
    ...
    mct "C'est une fille étrange."

# game/code/d08/extended/d08s09.rpy:53
translate french d08s09_00dd2458:

    # mc "Okay.{w=0.7}.. One.{w=0.7}.. Two.{w=0.7}.. Three..."
    mc "Ok.{w=0.7}.. un.{w=0.7}.. deux.{w=0.7}.. trois..."
...
translate french replay_d08s09_ea71cb25:

    # jf "FOOL!!! WHO HAS FALLEN INTO THE TRAP OF RKIL DVORKA?!"
    jf "IMBÉCILE!!! QUI EST TOMBÉ DANS LE PIÈGE DE RKIL DVORKA ?!"

# game/code/d08/extended/d08s09.rpy:71
translate french replay_d08s09_acb4aa2d:

    # mc "...IT IS I, [mcname] The DEFILER!"
    mc "...C'EST MOI, [mcname] LE PROFANATEUR !"
...
translate french replay_d08s09_67cd26ba:
    ...
    mc "Tu te moques de moi, putain ? Que se passe-t-il quand tu dois pisser ?"

# game/code/d08/extended/d08s09.rpy:102
translate french replay_d08s09_81f83e2b:
    ...
    jf "Notre technologie est supérieure ! Notre combinaison prend nos déchets et les transforme en eau et en nutriments qui sont réabsorbés par notre corps !"
...
translate french replay_d08s09_c6c6ccd4:
    ...
    jf "C'est tellement chaud, sors ton appareil photo et prends quelques photos !"
...
translate french replay_d08s09_195f54ba:
    ...
    jf "Peut-être ? Je ne sais pas.{w}.. Ouais !"

# game/code/d08/extended/d08s09.rpy:196
translate french replay_d08s09_f7cca815:

    # mc "We can do that next time."
    mc "La prochaine fois."
...
translate french replay_d08s09_f4ee5460:
    ...
    jf "C'était étonnamment plaisant."

# game/code/d08/extended/d08s09.rpy:210
translate french replay_d08s09_1006bf7b:
    ...
    mc "Est-ce que je t'ai dit que tu es vraiment superbe. Peut-être que quand j'aurai plus de temps, nous pourrons jouer à plus de Star Wars ou autre chose ensemble..."
...
translate french replay_d08s09_91d72008:
    ...
    mc "Oops? J'ai juste vu une opportunité et je l'ai saisie. {w}Est-ce que le costume va bien ?"
...
translate french replay_d08s09_caca7e3b:
    ...
    mc "Oh... Combien vas-tu recevoir pour le costume ?"
...
translate french replay_d08s09_337436e1:
    ...
    mc "Sous-facturé ? Combien a coûté tout ce matériel ?"

# game/code/d08/extended/d08s09.rpy:231
translate french replay_d08s09_e477c1b6:

    # jf "Well, I couldn't make the boots, so I had to buy them from another maker, and that was $800 for the pair."
    jf "Eh bien, je ne pouvais pas fabriquer les bottes, j'ai donc dû les acheter chez un autre fabricant, et la paire coûtait 800 $."
...
translate french replay_d08s09_6fbe7637:
    ...
    jf "J'ai consacré près de 80 heures à la construction, sans compter les recherches et..."
...
translate french replay_d08s09_32f58415:
    ...
    jf "Eh bien, c'est compliqué. Tu vois, je ne pense pas vraiment qu'il ait une petite amie."

# game/code/d08/extended/d08s09.rpy:243
translate french replay_d08s09_fe7c242f:
...
translate french replay_d08s09_cbdd5c3f:

    # jf "A lot of these guys have a thing for the girls in comics, superhero movies, games...whatever"
    jf "Beaucoup de ces gars ont un faible pour les filles dans les bandes dessinées, les films de super-héros, les jeux... peu importe."
...
translate french replay_d08s09_277e660b:
    ...
    mc "Euh. C'est bizarre, mais ce n'est pas la chose la plus bizarre dont j'ai jamais entendu parler.."
...
translate french replay_d08s09_60c65bb7:
    ...
    mc "Attends... une minute... attends. Tu ne lui as pas encore envoyé de photos de toi en costume ?"
...
translate french replay_d08s09_c3f00249:
    ...
    jf "C'est mon business, ma réputation. Je ne peux pas te laisser tout foutre en l'air en un instant."
...
translate french replay_d08s09_485c5b3f:
    ...
    mc "Donne-moi ta meilleure pose\"Je suis une reine Sith badass\"."

# game/code/d08/extended/d08s09.rpy:298
translate french replay_d08s09_afe5b0bd:

    # mc "Ok, send him that photo and say, \"Here you go, now please confirm your shipping address\"."
    mc "Ok, envoie-lui cette photo et dis :\"Et voilà, veuillez maintenant confirmer votre adresse de livraison\"."

# game/code/d08/extended/d08s09.rpy:300
translate french replay_d08s09_e0ec96d1:

    # mc "Please just do what I asked..."
    mc "S'il te plaît, fais juste ce que j'ai demandé..."

# game/code/d08/extended/d08s09.rpy:305
translate french replay_d08s09_36534fc1:

    # jf "**Sigh** All right, but that is not how this works."
    jf "**Soupir** Très bien, mais ce n'est pas comme ça que ça marche."

# game/code/d08/extended/d08s09.rpy:307
translate french replay_d08s09_c6ceba16:

    # jf "There. Did it. Now what?"
    jf "Voilà. Je l'ai fait. Et maintenant ?"

# game/code/d08/extended/d08s09.rpy:308
translate french replay_d08s09_30d47b7b:

    # mc "Just wait for his response. He paid you already, right?"
    mc "Attend simplement sa réponse. Il t'a déjà payé, non ?"

# game/code/d08/extended/d08s09.rpy:311
translate french replay_d08s09_f4d83ad5:
    ...
    jf "Bien sûr ! Je n'aurais pas pu acheter tous les matériaux et accessoires s'il ne l'avait pas fait. C'est pourquoi ma réputation est si importante. Les gens me font confiance pour livrer la marchandise et je le fais."

# game/code/d08/extended/d08s09.rpy:313
translate french replay_d08s09_9250fede:

    # jf "He is asking me to send more pictures. He says, he wants to make sure it is right."
    jf "Il me demande d'envoyer plus de photos. Il dit qu'il veut s'assurer que tout va bien."
...
translate french replay_d08s09_0905d529:
    ...
    jf "24h... en Belgique ? Cela va coûter beaucoup trop cher."

# game/code/d08/extended/d08s09.rpy:343
translate french replay_d08s09_4fd3ab1a:

    # mc "Just do it, Jessie."
    mc "Fais-le, Jessie."

# game/code/d08/extended/d08s09.rpy:345
translate french replay_d08s09_d8b4f473:

    # jf "Wait, he says, \"What is in the deluxe package?\""
    jf "Attends, il dit, \"Qu'y a-t-il dans le forfait de luxe ?\""
...
translate french replay_d08s09_b95d1f00:
    ...
    jf "300 $ pour 24h. Pas aussi cher que je le pensais."

# game/code/d08/extended/d08s09.rpy:358
translate french replay_d08s09_e33bec1b:

    # mc "Okay, I need you to get on your knees."
    mc "D'accord, j'ai besoin que tu te mettes à genoux."
...
translate french replay_d08s09_af806435:

    # mc "Now just kiss the tip of my dick."
    mc "Maintenant, embrasse juste le bout de ma bite."
...
translate french replay_d08s09_9f47a5c2:
    ...
    mc "Et dis-lui si tu attends jusqu'à..."
...
translate french replay_d08s09_d9837cd3:
    ...
    jf "Hahaha... Tu es putain de diabolique, d'accord."

# game/code/d08/extended/d08s09.rpy:384
translate french replay_d08s09_8bd996c6:

    # jf "If this works out, I’ll owe you one."
    jf "Si ça marche, je t'en devrai une."

# game/code/d08/extended/d08s09.rpy:388
translate french replay_d08s09_d3c00f78:

    # jf "I DON'T FUCKING BELIEVE IT! He's transferring the money!"
    jf "JE N'Y CROIS PAS PUTAIN ! Il transfère l'argent !"
...
translate french replay_d08s09_6bdab792:
    ...
    jf "D'accord, mais j'utilise mon appareil photo pour ça. Finies les photos de téléphones portables !"
