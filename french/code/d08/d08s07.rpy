...
translate french d08s07_b495adbf:
    ...
    sy "On dirait que que tu as un choix à faire."
...
translate french d08s07_c15dd178:
    ...
    mct "Malheureusement, elle a remarqué l'hostilité d'AmRose envers Lydia."
...
translate french d08s07_461482f0:
    ...
    mct "Je suis vraiment idiot des fois."
...
translate french d08s07_b22f923e:
    ...
    mc "je pensais juste \"Je suis vraiment idiot des fois.\""
...
translate french d08s07_64983e45:
    ...
    mct "On dirait que Lydia vient d'arriver également."
...
translate french d08s07_521a32f1:
    ...
    mc "Cool. Je reviens tout de suite."
...
translate french d08s07_aa5d6a1f:
    ...
    mes "Aww{w}, pour de vrai cette fois. Il est adorable."
...
translate french d08s07_0d89fc22:
    ...
    mc "Maintenant vous essayez juste tous les deux de me faire rougir."
...
translate french d08s07_a9bc9e96:
    ...
    mes "Donc, au moins, je peux m'attendre à ce que vous soyez tous les deux présents cette semaine ?"
...
translate french d08s07_1054764b:
    ...
    lc "Je veux dire, tu sais que je t'aime-"
...
translate french d08s07_f0dc74c5:
    ...
    lc "Mais je voulais juste quelques frites !"
...
translate french d08s07_cf82b4db:
    ...
    mc "{i}Quand finis-tu ton travail ?{/i}"
...
translate french d08s07_59a6d556:
    ...
    mct "Elle n'a pas corrigé Min !!! {w} JE SUIS LE ROI DU MONDE !!!"
...
translate french d08s07_de9d394f:
    ...
    mes "Tu me disais pourquoi tu ne serais pas à la fête cette semaine."

# game/code/d08/d08s07.rpy:277
translate french d08s07_54c0aed8:

    # mct "Wait, the king of the world died frozen in the ocean."
    mct "Attendez, le roi du monde est mort gelé dans l'océan."
...
translate french d08s07_bc0a70a9:
    ...
    mct "Je dois y aller, sinon Lydia et tout le monde verront {u}cette{/u} photo..."

# game/code/d08/d08s07.rpy:308
translate french d08s07_b95f1533:

    # mct "... as well as everything else I've been up to recently."
    mct "... ainsi que tout ce que j'ai fait récemment."
...
translate french d08s07_f9a4640e:
    ...
    mct "Je ne veux pas gâcher mes chances avec le VIP Challenge, mais je ne veux pas non plus gâcher mes chances avec Lydia..."

# game/code/d08/d08s07.rpy:314
translate french d08s07_5017ad5b:

    # mes "Although, it does look like he's having second thoughts."
    mes "Même si on dirait qu'il a des doutes."
...
translate french d08s07_e0a54d6e:
    ...
    mct "Je ne peux pas aller à la fête avec Lydia et lui laisser voir quel genre de choses j'apprécie..."
...
translate french d08s07_b148c30b:
    ...
    mct "...mais comment aller à la Fête sans elle sans la perdre ?"
...
translate french d08s07_9aa5dd7c:
    ...
    mc "La semaine dernière était géniale. Je me suis bien amusé, mais le meilleur de tout... j'ai pu parler avec toi."

# game/code/d08/d08s07.rpy:329
translate french d08s07_df5b7e97:

    # mc "Like Min said earlier, last week at the party we \"hooked up\"."
    mc "Comme Min l'a dit plus tôt, la semaine dernière, à la fête, on \"s'est rapproché\"."

# game/code/d08/d08s07.rpy:330
translate french d08s07_b03cb304:

    # mc "So, I just assumed you'd be there again this week."
    mc "Donc, j'ai juste supposé que tu serais là encore cette semaine."
...
translate french d08s07_ab57b8e3:
    ...
    mc "J'avais oublié que tu ne te sentais pas à l'aise la semaine dernière... {w}que ce n'est pas ton genre de fête."
...
translate french d08s07_62e151ff:
    ...
    mes "Oh. {w}Je crois que je peux comprendre ça."
...
translate french d08s07_ef954a09:
    ...
    lc "Donnons-nous le temps de réfléchir à ce que nous voulons dire, ouais."
...
translate french d08s07_1439cafa:
    ...
    lc "Quelqu'un a vu de bons films ces derniers temps ?"

translate french strings:

    # game/code/d08/d08s07.rpy:99
    old "Min is lovely, but Lydia is gorgeous"
    new "Min est adorable, mais Lydia est magnifique"

    # game/code/d08/d08s07.rpy:99
    old "You're both beautiful"
    new "Vous êtes tous les deux magnifiques"
