...
translate french d08s05_06a950b5:

    # "11:00 AM"
    "11:00"

# game/code/d08/d08s05.rpy:13
translate french d08s05_0c829b89:

    # sy "So, this is the University? I might have made the wrong choice for my higher education."
    sy "Alors c'est ça l'université ? J'ai peut-être fait le mauvais choix pour mes études supérieures."
...
translate french d08s05_7bfd3d68:
    ...
    sy "Alors, maintenant que nous sommes là... {w}Quel est le plan ?"
...
translate french d08s05_e673201b:
    ...
    mc "Nous recherchons Dahlia. Elle devrait être par ici."
...
translate french d08s05_6d30b682:
    ...
    sy "Dahlia fréquente cette université ?"
...
translate french d08s05_dce25133:
    ...
    mc "Elle m'a dit qu'il valait mieux oublier les bagages et passer à autre chose."
...
translate french d08s05_dd_ede96a43:
    ...
    sy "Euh… non ? {w}Bonjour Daisy, je suis la sœur de [mcname]."
...
translate french d08s05_dd_abae32e1:
    ...
    sy "Um non. {w}Bonjour Daisy, [mcname] et moi sommes amis depuis presque toujours."

# game/code/d08/d08s05.rpy:101
translate french d08s05_dd_9a7079ba:

    # sy "My name is Stacy."
    sy "Je m'appelle Stacy."
...
translate french d08s05_dd_f0639b31:

    # mc "We were actually hoping to see you."
    mc "En fait, on espérait te voir."
...
translate french d08s05_dd_a53f1da1:
    ...
    dd "Oh, je ne connais pas vraiment Samiya..."

# game/code/d08/d08s05.rpy:122
translate french d08s05_dd_14041de3:

    # mc "But you surely know Dah-"
    mc "Mais tu connais sûrement Dah-"
...
translate french d08s05_dd_b292b593:
    ...
    sy "Alors, tu la connais ?"

# game/code/d08/d08s05.rpy:133
translate french d08s05_dd_02c7b059:

    # dd "Well, yeah. Sorta."
    dd "Eh bien, ouais. En quelque sortes."

# game/code/d08/d08s05.rpy:135
translate french d08s05_dd_1d7fc9ca:

    # mc "You went to high school with Samiya? And Dahlia too?"
    mc "Tu as été au lycée avec Samiya ? Et Dahlia aussi ?"
...
translate french d08s05_dd_2cd36bd2:
    ...
    sy "Tu peux nous dire quelque chose sur Samiya ?"
...
translate french d08s05_dd_a3ea74e4:
    ...
    dd "Dahlia et Samiya ne se sont jamais entendues."
...
translate french d08s05_dd_a34281ac:
    ...
    mc "Était-ce le Roi du Bal dont parlait Dahlia ? Celui qui a rejeté Samiya ?"

# game/code/d08/d08s05.rpy:164
translate french d08s05_dd_f5eb4f21:

    # dd "Ha! Oh, yeah. There's a funny story about that."
    dd "Ha! Oh ouais. Il y a une drôle d'histoire à ce sujet."
...
translate french d08s05_dd_757d136e:
    ...
    sy "Alors, Samiya a crevé les pneus du gars ?"

# game/code/d08/d08s05.rpy:178
translate french d08s05_dd_6ea4ab56:

    # dd "Oh, no. Definitely not."
    dd "Oh non. Certainement pas."

# game/code/d08/d08s05.rpy:180
translate french d08s05_dd_90226541:
...
translate french d08s05_dd_010d4f6d:

    # dd "Anyway, so Dahlia put on this big campaign for Prom Queen, even though everybody knew she wouldn't win."
    dd "Bref, Dahlia a lancé cette grande campagne pour devenir Reine du bal, même si tout le monde savait qu'elle ne gagnerait pas."

# game/code/d08/d08s05.rpy:187
translate french d08s05_dd_b15e19b8:

    # sy "That's kinda sad."
    sy "C'est un peu triste."
...
translate french d08s05_dd_170e43ed:

    # dd "Totally pissed. Or at least, that's what I imagine."
    dd "Complètement en colère. Ou du moins, c'est ce que j'imagine."
...
translate french d08s05_dd_fbe676e7:
    ...
    dd "Alors, il est environ 4 heures du matin et le petit ami de Dahlia arrive et commence à en parler à tout le monde."
...
translate french d08s05_dd_d1d905d4:
    ...
    sy "Les hommes sont de vrais connards."
...
translate french d08s05_dd_8b530a58:

    # dd "Samiya knocked his ass out with one punch. Right there in front everybody."
    dd "Samiya l'a assommé d'un seul coup de poing. Là, devant tout le monde."

# game/code/d08/d08s05.rpy:231
translate french d08s05_dd_698d7569:
...
translate french d08s05_dd_652f3f87:
    ...
    dd "Ouais, et la voiture de la B était la seule encore sur le parking."

# game/code/d08/d08s05.rpy:243
translate french d08s05_dd_c1dff962:
...
translate french d08s05_dd_fcbc2278:
    ...
    mc "Bien sûr, elle m'a fait visiter les lieux à mon arrivée."
...
translate french d08s05_dd_3620c7bb:
    ...
    dd "Bien sûr. Elle est quasiment toujours à la piscine."
...
translate french d08s05_dw_0a84f66d:
    ...
    dw "Oh, si ce n'est pas l'esclave que je préfère le moins."
...
translate french d08s05_dw_f867e91d:
    ...
    mc "Dahlia! {w}C'est Stacy. Stacy, voici Dahlia."
...
translate french d08s05_dw_7458e4ba:
    ...
    # mc "But, I don't want-"
    mc "Mais, je ne veux pas-"

# game/code/d08/d08s05.rpy:388
translate french d08s05_dw_5ee80470:

    # dw "No, no, no. Don't lie. You know you want to play."
    dw "Non non Non. Ne mens pas. Tu sais que tu veux jouer."

# game/code/d08/d08s05.rpy:391
translate french d08s05_dw_4b5ff222:

    # mc "*sigh* Yes, Mistress."
    mc "*soupir* Oui, Maîtresse."
...
translate french d08s05_dw_b5d6a09a:
    ...
    mc "Tu ne peux pas vouloir que je fasse ça ici... en public ?"
...
translate french d08s05_dw_07dcbcad:
    ...
    mc "Je veux dire, s'il te plaît, non. S'il vous plaît, ne faites pas ça, Maîtresse."

# game/code/d08/d08s05.rpy:409
translate french d08s05_dw_2231a2cf:

    # mc "Yes, Mistress. Please forgive me, Mistress."
    mc "Oui Maîtresse. S'il vous plaît, pardonnez-moi, Maîtresse."

# game/code/d08/d08s05.rpy:411
translate french d08s05_dw_8fe19cec:

    # dw "Better. Now kneel."
    dw "Mieux. Maintenant, agenouille-toi."
...
translate french d08s05_dw_ee2aaa9b:
    ...
    sy "Oh mon Dieu, oui. Fait-il des tours ?"
...
translate french d08s05_dw_975ccae0:
    ...
    dw "Hmm... il y a quelque chose qui ne va pas ici."
...
translate french d08s05_dw_6ec54438:

    # dw "Hmm... Stacy, how should he correct his apparel?"
    dw "Hmm... Stacy, comment devrait-il corriger ses vêtements ?"

# game/code/d08/d08s05.rpy:452
translate french d08s05_dw_7eef1638:

    # sy "Oh, well... {w}Clearly he should be barefoot."
    sy "Oh, eh bien... {w}Il est clair qu'il devrait être pieds nus."

# game/code/d08/d08s05.rpy:454
translate french d08s05_dw_ae3b6be8:

    # dw "Excellent suggestion."
    dw "Excellente suggestion."

# game/code/d08/d08s05.rpy:457
translate french d08s05_dw_4cd8fefd:

    # dw "Slave, take off your shoes."
    dw "Esclave, enlève tes chaussures."
...
translate french d08s05_dw_7d0f621d:

    # mc "I'm unsure, Mistress."
    mc "Je ne suis pas sûr, Maîtresse."
...
translate french d08s05_dw_da6a3daa:

    # sy "I hate to interrupt. This is a lot of fun, but-"
    sy "Je déteste interrompre. C'est très amusant, mais-"
...
translate french d08s05_dw_a0a7a5a7:
    ...
    sy "Elle a volé mes bagages."

# game/code/d08/d08s05.rpy:493
translate french d08s05_dw_bda7583a:

    # dw "Whatever... {w}Fine. I'll tell you where you can find someone who will know where she is."
    dw "Quoi qu'il en soit... {w}Très bien. Je vais te dire où tu peux trouver quelqu'un qui saura où elle est."
...
translate french d08s05_dw_d661b00b:
    ...
    dw "S'il a un peu de cervelle, il se souvient d'Allison. La fille qui était toujours à la piscine..."

# game/code/d08/d08s05.rpy:527
translate french d08s05_dw_6d8d2ea3:
...
translate french d08s05_dw_dbaf6043:
    ...
    dw "Bien sûr. Elle est toujours à la piscine."

# game/code/d08/d08s05.rpy:535
translate french d08s05_dw_73f71408:

    # mc "What the fuck was that?!"
    mc "C'était quoi, ce bordel ?!"
...
translate french d08s05_dw_8a87e0d1:
    ...
    mc "Tu n'avais pas besoin de t'asseoir sur moi !"
...
translate french d08s05_dw_1d0e9828:
    ...
    sy "Allons trouver cette Allison."
