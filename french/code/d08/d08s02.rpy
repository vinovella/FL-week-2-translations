...
translate french d08s02_7ed15712:

    # arj "I dunno. I always thought the perfect amount makes it look natural."
    arj "Je ne sais pas. J'ai toujours pensé que la quantité parfaite donnait un aspect naturel."

# game/code/d08/d08s02.rpy:11
translate french d08s02_38ca337f:

    # sy "Yeah, but the Kardashians are unrecognizable without a thick layer..."
    sy "Ouais, mais les Kardashian sont méconnaissables sans une couche épaisse..."
...
translate french d08s02_00eb977b:
    ...
    arj "Ha! je n'y crois pas."

# game/code/d08/d08s02.rpy:24
translate french d08s02_df3ed211:

    # sy "He's just being nice."
    sy "Il est juste gentil."
...
translate french d08s02_9f2e4146:
    ...
    sy "C'est vrai... et honnête."

# game/code/d08/d08s02.rpy:31
translate french d08s02_d9da64b7:

    # mc "I think AmRose has figured out how to tell the difference over the years."
    mc "Je pense qu'AmRose a compris comment faire la différence au fil des années."
...
translate french d08s02_3c701cb0:
    ...
    mc "Tu dis ça comme si c'était une mauvaise chose."
...
translate french d08s02_aa573f2e:
    ...
    arj "Eh bien, ne t'entraîne pas sur moi ! Je préfère que tu sois honnête."
...
translate french d08s02_02295805:
    ...
    sy "Bien sûr. Elle est dans ma chambre."
...
translate french d08s02_e82785ee:

    # sy "I didn't steal it. You left it behind, and I recovered it."
    sy "Je ne l'ai pas volé. Tu l'as laissé et je l'ai récupéré."
...
translate french d08s02_82ccae64:
    ...
    sy "Ensuite, elle pourrait ajouter 2 autres concombres."

# game/code/d08/d08s02.rpy:100
translate french d08s02_5a939688:

    # arj "Woah! Three large cucumbers? That's insane."
    arj "Waouh ! Trois gros concombres ? C'est dingue."

# game/code/d08/d08s02.rpy:103
translate french d08s02_4d6f365a:

    # sy "Oh, that's just to get started. Then it usually goes to inflatable objects."
    sy "Oh, c'est juste pour commencer. Ensuite, il s'agit généralement d'un objet gonflable."
...
translate french d08s02_29a0c7b1:
    ...
    sy "Ouais, ça ressemble un peu à un tour de magie. Je veux dire, ce sont juste des ballons."
...
translate french d08s02_213757b7:
    ...
    arj "Je ne peux même pas l'imaginer."

# game/code/d08/d08s02.rpy:124
translate french d08s02_d6a708f5:

    # mc "Seriously, I'm trying to eat here."
    mc "Sérieusement, j'essaye de manger là."
...
translate french d08s02_809ed845:
    ...
    arj "Non non. Je n'en avais jamais entendu parler avant-"
...
translate french d08s02_f1b59e15:
    ...
    arj "Aww, allez [mcname]. C'est une question simple."
...
translate french d08s02_9e8acfc2:
    ...
    mc "Non, je n'ai jamais rencontré une fille qui aimait ce genre de choses."

# game/code/d08/d08s02.rpy:147
translate french d08s02_16e06539:

    # sy "Okay, but I'm asking about you. There was a lot of guys shoving-"
    sy "D'accord, mais je pose des questions sur toi. Il y avait beaucoup de gars qui ador-"

# game/code/d08/d08s02.rpy:149
translate french d08s02_83b8a4b5:

    # mc "Nope! Nope! Nope!"
    mc "Non! Non! Non!"

# game/code/d08/d08s02.rpy:151
translate french d08s02_1263dd0d:

    # mc "I am checking out of this conversation."
    mc "Je me retire de cette conversation."
...
translate french d08s02_33bab2a0:
    ...
    sy "Oh ouais. Y'avait un peu de tout."

# game/code/d08/d08s02.rpy:161
translate french d08s02_60652925:

    # mc "Stacy! Don't say-"
    mc "Stacy! Ne dis pas-"

# game/code/d08/d08s02.rpy:162
translate french d08s02_e3837dd8:

    # sy "Straight porn, group sex, lesbians..."
    sy "Porno hétéro, orgie, lesbiennes..."

# game/code/d08/d08s02.rpy:164
translate french d08s02_db058ec7:

    # sy "... tentacle sex anime, real actors swimming naked with octopuses..."
    sy "... Hentai avec des tentacules, des vrais acteurs nageant nus avec des poulpes..."
...
translate french d08s02_e9a7efb3:
    ...
    # mc "Can we just not-"
    mc "Pouvons-nous juste ne pas-"

# game/code/d08/d08s02.rpy:188
translate french d08s02_3d890773:

    # sy "Well, aside from letting you watch."
    sy "Eh bien, à part te laisser regarder."
...
translate french d08s02_6a30bcdc:
    ...
    sy "Mais ils ont dû faire des choses..."
...
translate french d08s02_d8649032:

    # mct "What's this? Oh, it's a text from Lydia."
    mct "Qu'est-ce que c'est ? Oh, c'est un texto de Lydia."
...
translate french d08s02_e5d30663:

    # mct "Oh, and I missed a text from Pete this morning."
    mct "Oh, et j'ai raté un texto de Pete ce matin."
...
translate french d08s02_dcabad5a:
    ...
    mc "Oui, Lydia est la fille avec qui je sors."
...
translate french d08s02_84e5ec97:
    ...
    mc "Nous avons été ensemble plusieurs fois, mais un seul rendez-vous officiel jusqu'à présent."
...
translate french d08s02_f82b7758:
...
translate french d08s02_8fdbd92f:
    ...
    mc "Non, c'est une nouveauté pour moi."
...
translate french d08s02_c5b31f4f:
    ...
    arj "Je préfère ne pas le dire..."

# game/code/d08/d08s02.rpy:257
translate french d08s02_a3be9952:

    # mc "Sorry Stacy, sometimes these messages are private."
    mc "Désolé Stacy, parfois ces messages sont privés."

# game/code/d08/d08s02.rpy:259
translate french d08s02_a7c62671:

    # arj "Yeah."
    arj "Ouais."

# game/code/d08/d08s02.rpy:262
translate french d08s02_ff3c53c9:

    # sy "Oh... okay."
    sy "Oh... ok."

# game/code/d08/d08s02.rpy:266
translate french d08s02_00d9a386:

    # sy "Well, if you guys are both done staring at your phones..."
    sy "Eh bien, si vous avez tous les deux fini de regarder vos téléphones..."

# game/code/d08/d08s02.rpy:269
translate french d08s02_b63f0842:
...
translate french d08s02_b43bd301:
    ...
    mc "Pas encore. Retrouve-moi après les cours et nous trouverons une solution."
