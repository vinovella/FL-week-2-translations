...
translate french after_credits_800a01f9:

    # sy "Wait there is a door."
    sy "Attends, il y a une porte."
...
translate french after_credits_b745d2c8:
    ...
    sy "Je pense que c'est pourquoi que nous sommes ici !"

# game/code/labels.rpy:199
translate french after_credits_04bc41f8:

    # "{color=#f93737}Unknown Girl 1{/color}" "What is going on?"
    "{color=#f93737}Fille inconnue 1{/color}" "Qu'est-ce qui se passe ?"
...
translate french after_credits_2d991197:
    ...
    "{color=#f93737}Fille inconnue 1{/color}" "Des jeunes de l'université. Apparemment, ils ne savent pas lire !"

# game/code/labels.rpy:213
translate french after_credits_e5b76018:
...
translate french after_credits_7e6fe4d2:
    ...
    "{color=#ba50f3}Fille inconnue 2{/color}" "Ils ont ouvert la porte..."
...
translate french after_credits_38b8e047:
    ...
    "{color=#f93737}Fille inconnue 1{/color}" "Vous l'avez entendue."
...
translate french after_credits_b7af7f44:
    ...
    "{color=#ec8664}Fille inconnue 3{/color}" "Bientôt vous pourrez en savoir plus sur nous."
...
translate french after_credits_dc4bfcb4:
    ...
    dd "Pas vraiment... Nous sommes hors du scénario, hors canon et hors chronologie."

# game/code/labels.rpy:284
translate french after_credits_ea09095a:

    # dd "There are no consequences here! Let's just have sex, Stacy!"
    dd "Il n'y a aucune conséquence ici ! Faisons l'amour, Stacy !"

# game/code/labels.rpy:287
translate french after_credits_395b12fe:

    # sy "Fuck Yeah!"
    sy "Putain ouais!"

# game/code/labels.rpy:291
