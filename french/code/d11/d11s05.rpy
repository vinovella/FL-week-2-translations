...
translate french d11s05_fdff4ad1:
    ...
    mct "J'espère que Daisy va bien...J'aurais aimé rester avec elle."

# game/code/d11/d11s05.rpy:36
translate french d11s05_541c5fd9:

    # mct "Hmm.{w}.. Maybe I should try to crack Pete's laptop again."
    mct "Hmm.{w}.. Peut-être que je devrais réessayer de pirater l'ordinateur portable de Pete."
...
translate french d11s05_c0d03cc7:
    ...
    mct "Attendez, ce sont toutes les photos que j'ai prises pour Fetish Locator..."

# game/code/d11/d11s05.rpy:125
translate french d11s05_871d3cfb:

    # mct "Did he buy them or something?"
    mct "Il les a acheté ou quoi ?"
...
translate french d11s05_52670fa9:
    ...
    mct "D'accord...C'était...inattendu, mais au moins il ne semble pas être le cerveau ici."
...
translate french d11s05_f94b4ed4:
    ...
    mct "Je suppose qu'il aime participer aux escapades sexuelles des autres, hein."
...
translate french d11s05_783527c4:
    ...
    mct "Je ne veux pas y croire, mais peut-être qu'il est doué pour brouiller les pistes ?"
...
translate french d11s05_780ad7ac:
    ...
    mct "J'ai besoin d'un moyen décisif pour savoir si Pete est dans le coup ou pas..."
...
translate french d11s05_8f94dc42:
    ...
    mct "Je pourrais utiliser ça pour mettre Pete dans le programme VIP."

# game/code/d11/d11s05.rpy:154
translate french d11s05_f7787473:

    # mct "I can remotely delete Pete's account from here..."
    mct "Je peux supprimer le compte de Pete à distance à partir d'ici..."
...
translate french d11s05_c61d471a:
    ...
    mct "Si Pete ne travaille pas pour Fetish Locator, il devrait être éligible."
...
translate french d11s05_f77136f4:
    ...
    mct "Cela n'augmenterait pas mes chances de gagner d'ajouter Pete aux défis VIP."
...
translate french d11s05_10e272df:
    ...
    mct "Je baiserais mon ami à fond s'il s'avérait innocent."
...
translate french d11s05_b0ad562e:
    ...
    mct "Je l'ai déjà assez trahi comme ça."
...
translate french d11s05_82bead1d:
    ...
    mc "Alors, euh...Je voulais juste te demander si tu serais prêt à sortir avec moi ?"
...
translate french d11s05_bda1d96f:
    ...
    mc "Très bien, je te verrai là-bas alors. Au revoir."
