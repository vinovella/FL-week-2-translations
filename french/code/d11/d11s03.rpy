...
translate french d11s03_be98c79a:
    ...
    mc "Je vous retrouverai plus tard, d'accord ?"
...
translate french d11s03_ad461e97:
    ...
    lc "Je suis sûre que nous sommes toutes les deux belles, mais ce serait un peu étrange si mon petit ami t'appelait comme ça, n'est-ce pas ?"
...
translate french d11s03_3050e7a9:
    ...
    lc "La rupture de Min et Antony. {w}Antony est un connard exceptionnel sur ce coup."
...
translate french d11s03_742f765c:
    ...
    lc "Il m'a envoyé cet e-mail plein de mensonges et de demi-vérités - pour essayer de faire honte à ma meilleure amie."
...
translate french d11s03_b00e57f9:
    ...
    cl "J'en ai un aussi. \"pute salope dégoûtante\" a été utilisée une vingtaine de fois."
...
translate french d11s03_bbd29f6c:
    ...
    lc "Min va lui botter le cul quand elle le découvrira, et je ne lui en voudrais pas."

# game/code/d11/d11s03.rpy:138
translate french d11s03_bb02bceb:

    # cl "Meh. It doesn't bother me. He's not worth it."
    cl "Meh. Cela ne me dérange pas. Il n'en vaut pas la peine."
...
translate french d11s03_918b205e:
    ...
    cl "Je suis sûr qu'il était ivre à ce moment-là. Il n'aurait jamais les couilles de s'en prendre à Min comme ça s'il était sobre."
...
translate french d11s03_2bbfbf26:
    ...
    lc "Je ne suis pas sûr que cela compte. Il a montré son vrai visage. C'est un être humain horrible, et tout le monde devrait le savoir maintenant."
...
translate french d11s03_3ac4cef5:
    ...
    cl "...mais ce n'est pas un si mauvais gars. Je lui balancerais bien encore une ou deux conneries."

# game/code/d11/d11s03.rpy:152
translate french d11s03_ef9482e9:

    # lc "You wouldn't - "
    lc "Tu ne le feras pas -"
...
translate french d11s03_375467f3:
    ...
    cl "Non bien sûr que non. {w}Je devrais m'inquiéter maintenant de ce qu'il en dirait par la suite."

# game/code/d11/d11s03.rpy:156
translate french d11s03_fe81e111:

    # cl "Can't trust him anymore."
    cl "Je ne peux plus lui faire confiance."
...
translate french d11s03_12b2fa40:
    ...
    lc "Nous devrions faire quelque chose. On ne peut pas lui permettre de s'en tirer comme ça."
...
translate french d11s03_af377c00:
    ...
    cl "Eh bien, je ne le laisserai pas me jeter sur une table de billard pour me frapper profondément avec sa queue – je vais te le dire."
...
translate french d11s03_74de57fb:
    ...
    lc "Pas grand chose. Nous discutions justement du devoir de recherche de notre dernier cours."

# game/code/d11/d11s03.rpy:168
translate french d11s03_cdfd4d97:

    # mc "Huh. Nordin never assigns us research projects."
    mc "Hein. Nordin ne nous confie jamais de projets de recherche."
...
translate french d11s03_cc10ca32:
    ...
    cl "Eh bien, tu sais comment est maman. Elle n'est jamais heureuse à moins que vous soyez plongé dans un livre de bibliothèque."
...
translate french d11s03_ae403cf2:
    ...
    lc "Le professeur Lewald confie toujours des projets de recherche et des essais."
...
translate french d11s03_52dd3e2b:
    ...
    lc "Elle semble penser que c'est la meilleure façon d'apprendre et de conserver ses connaissances."
...
translate french d11s03_39ed49ab:
    ...
    lc "Alors, je sais que tu as passé un bon moment hier soir."
...
translate french d11s03_6e12bb67:
    ...
    cl "Tu peux dire ça. Ce que j'ai dit, c'est que ça fait mal de s'asseoir."
...
translate french d11s03_e0237213:
    ...
    lc "Toujours. Aucun d’eux n’était dans la classe."
...
translate french d11s03_744338bc:
    ...
    mct "Je ne peux pas dire s'il y a une histoire intéressante dont je voudrais en savoir plus ou si je devrais rester en dehors de cette conversation."
...
translate french d11s03_b624427f:
    ...
    lc "Tu ne m'as toujours pas dit pourquoi tu avais ces bleus. Juste que tu as apprécié."
...
translate french d11s03_3d0c7425:
    ...
    lc "Oh allez. J'étais invité. Je n'y suis tout simplement pas allé cette fois. Ça pourrait être bien de me le dire."
...
translate french d11s03_3e5dd6ff:
    ...
    cl "Là encore, ce n’est pas le meilleur moment. D'autres personnes pourraient nous entendre accidentellement."

# game/code/d11/d11s03.rpy:234
translate french d11s03_64f6c9cf:

    # lc "I guess you're right."
    lc "Je suppose que tu as raison."
...
translate french d11s03_1cb79e45:
    ...
    cl "Ouais, je dois aussi aller à la répétition. Je vais d'abord terminer ici."
...
translate french d11s03_b7583ae3:
    ...
    cl "Tu sais, je pensais à quelque chose hier soir pendant que tu traînais Squizzle sur scène même si elle n'était pas censée faire partie de l'événement principal."
...
translate french d11s03_f40f1a84:
    ...
    cl "Imagine ce qui se passerait si ta petite amie apprenait à quel point tu t'es vraiment amusé lors de la fête d'hier soir."
...
translate french d11s03_4a1f60c6:
    ...
    cl "Que tu m'as plaqué contre le mur et que tu m'as ramoné la porte arrière, puis plus tard avec Min que tu as alterné entre lui pisser dans la bouche et marteler sa chatte."
...
translate french d11s03_e1de5751:
    ...
    cl "Que tu m'as plaqué contre le mur et violé la porte arrière, puis plus tard avec Min que tu as alterné entre lui pisser dans la bouche et marteler sa chatte."
...
translate french d11s03_0b2bf9ba:
    ...
    cl "Elle pourrait pardonner l'un ou l'autre, ou ne pas croire, mais les deux dans la même nuit ?"
...
translate french d11s03_c6912e33:
    ...
    cl "Ne t'inquiète pas. Je ne vais rien lui dire."
...
translate french d11s03_ddd584c4:
    ...
    cl "A moins que tu veuilles que Lydia découvre que tu la trompes."
...
translate french d11s03_941b5923:
    ...
    cl "Bien. Je suis content que nous nous comprenions."
...
translate french d11s03_a2c20e1e:
    ...
    cl "Je ne pense pas que tu comprennes-"
...
translate french d11s03_c991a27d:
    ...
    mc "Je lui ai déjà raconté que je t'avais bourrer le cul."

# game/code/d11/d11s03.rpy:347
translate french d11s03_42e49392:

    # mc "You had better hurry up and tell her before I do."
    mc "Tu ferais mieux de te dépêcher et de lui dire avant moi."
...
translate french d11s03_4bd3a4d6:
    ...
    cl "Tu ne joues qu'avec moi. Tu ne lui as pas parlé de nous."
...
translate french d11s03_7739149e:
    ...
    cl "Quoi ?! {w}Qu'est-ce que tu dis ?"
...
translate french d11s03_72484ba7:
    ...
    mc "Je ne dis rien. Mais si je le voulais, tu sais ce que je pourrais lui dire ?"
...
translate french d11s03_be0d3112:
    ...
    mc "Ne t'inquiète pas. Je n'en veux pas."
...
translate french d11s03_bb86e639:
    ...
    mc "*soupir* On ne peut pas plaire à tout le monde."
...
translate french d11s03_812d91eb:
    ...
    cl "Oh, d'accord.{w} Je...je devrais partir maintenant."
...
translate french d11s03_66ded5f5:
    ...
    cl "Ouais. Quelqu’un m’a vraiment fait sortir la merde de mon cul et de mes cuisses."
...
translate french d11s03_a041bb86:
    ...
    sy "Tu sais, cette sauce que tu m'as préparée une fois et que tu lui as donnée plusieurs fois en privé ?"

# game/code/d11/d11s03.rpy:435
translate french d11s03_12a841e3:

    # mc "Oh, you mean that tomato sauce?"
    mc "Oh, tu veux dire cette sauce tomate ?"
...
translate french d11s03_7ff41209:
    ...
    arj "Laisse tomber. Juste...{w}Peu importe, d'accord ?"
...
translate french d11s03_20918a1c:
    ...
    arj "C'est si bon, si épais et si serré."

# game/code/d11/d11s03.rpy:457
translate french d11s03_6a62010d:

    # arj "It's so groovy-"
    arj "C'est tellement génial-"
...
translate french d11s03_2c0573bd:
    ...
    sy "pas grand-chose.{w} Bon appétit."
...
translate french d11s03_74e09821:
    ...
    mc "Alors, Stacy, c'est quoi ces cheveux ?"
...
translate french d11s03_211ac65e:
    ...
    sy "Cela semblait être une couleur amusante – pour la fête."
...
translate french d11s03_94c41330:
    ...
    sy "Je ne suis pas sûr de vouloir...{w}Tu n'aimes pas ?"
...
translate french d11s03_a8c0716d:
    ...
    arj "Rien n’est trop cool pour que Stacy réussisse. Elle est l'essence même du cool."
...
translate french d11s03_e0d8a58d:
    ...
    sy "Ta bite d'homme est plus grosse que la nôtre. J'ai vu la collection d'AmRose."
...
translate french d11s03_140d770a:
    ...
    sy "Ils n'étaient pas vraiment cachés."
...
translate french d11s03_e6e270c5:
    ...
    mct "Au moins, ils ont arrêté de parler de ma collection porno."
...
translate french d11s03_52f08b9e:
    ...
    mct "Je me demande si je devrais même les reprendre à Stacy. Je ne semble plus en avoir besoin."
...
translate french d11s03_944ea3e9:
    ...
    sy "Hum, j'étais à la fête hier soir. Je n'ai pas détourné le regard pendant l'événement principal."
...
translate french d11s03_4407e3a0:
    ...
    mc "Regarder quoi ? Qu'est-ce que je regardais ?"
...
translate french d11s03_5058e05d:
    ...
    arj "Hein ? Moi ? {w}Je pensais que nous donnions du fil à retordre à [mcname]."
...
translate french d11s03_eca6b3c3:
    ...
    mc "Je suppose que c'est une bonne question. J'aimerais aussi connaître la réponse à cette question."

# game/code/d11/d11s03.rpy:588
translate french d11s03_888bfef5:

    # arj "What was the question?"
    arj "Quelle était la question ?"
...
translate french d11s03_2566cedc:
    ...
    arj "Ce n'était pas comme ça. C'était juste du sexe. {w}Je n'étais pas jalouse que tu baises avec quelqu'un d'autre."
...
translate french d11s03_f45cbf3c:
    ...
    sy "Mais alors...{w} Oh ! C'est parfait !"
...
translate french d11s03_fe452c50:
    ...
    mc "Oh super. {w}Alors, qu'est-ce que tu disais ?"
...
translate french d11s03_cbf3a1c0:
    ...
    sy "Si tu veux baiser autant de monde d'ici lundi, on devrait organiser une fête."

# game/code/d11/d11s03.rpy:693
translate french d11s03_5ce4b801:

    # mc "That's not a bad idea."
    mc "Ce n'est pas une mauvaise idée."
...
translate french d11s03_0e78ba79:
    ...
    sy "Oh, je vois ce que tu veux dire. {w}Peut-être, si c'est une orgie ?"
...
translate french d11s03_3bff5968:
    ...
    sy "Bon point. {w}Peut-être pourrions-nous organiser des événements comme ceux d'hier soir."
...
translate french d11s03_f9079272:
    ...
    mc "Je pense cependant que vous avez une bonne idée. L'idée de la fête est vraiment bonne."

# game/code/d11/d11s03.rpy:726
translate french d11s03_5db80719:

    # sy "Okay. You finished your food?"
    sy "D'accord. Tu as fini ton repas ?"
...
translate french d11s03_f2cac3fe:
    ...
    arj "Elle est impolie, mais elle a raison. {w}Nous ferons plus de choses à deux."

# game/code/d11/d11s03.rpy:739
translate french d11s03_2f241977:

    # mc "Sure, sure. {w}I've got places to be anyway."
    mc "Bien-sûr. {w}Je sais où aller de toute façon."
...
translate french d11s03_6519e4d4:
    ...
    sy "Alors, quand nous étions enfants, il y avait ce jeu de laine que notre mère faisait pour les fêtes d'anniversaire..."
...
translate french d11s03_7a5f3e86:
    ...
    sy "Alors, quand j'étais enfant, il y avait ce jeu de laine que ma mère faisait pour les fêtes d'anniversaire..."

# game/code/d11/d11s03.rpy:750
translate french d11s03_b25a350c:

    # mct "Oh my dear and fluffy Lord..."
    mct "Oh mon cher et moelleux Seigneur..."

translate french strings:

    # game/code/d11/d11s03.rpy:317
    old "Play Along for Now"
    new "Jouez le jeu pour l'instant"
