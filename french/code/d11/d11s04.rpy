...
translate french d11s04_95a7047b:
    ...
    mct "Je devrais aller voir Daisy maintenant"
...
translate french d11s04_060f55d0:
    ...
    mc "C'est la 15ème fois que tu me dis ça. Pourquoi as-tu si peur des hôpitaux ?"
...
translate french d11s04_65de30fb:
    ...
    mc "Comment a-t-il...? Si cela ne te dérange pas..."
...
translate french d11s04_0c4c8ba1:
    ...
    dd "Cardiomyopathie. {w}Au moins, c'est ce que ces charlatans ont dit."

# game/code/d11/d11s04.rpy:91
translate french d11s04_57643ce3:

    # dd "Who the fuck knows anyway really?"
    dd "De toute façon, qui le sait vraiment ?"
...
translate french d11s04_581d7b68:
    ...
    "Réceptionniste" "Mme Diamond? {w}Daisy Diamond?"
...
translate french d11s04_9abb9fb7:
    ...
    # "Doctor" "Please, sit."
    "Docteur" "S'il vous plaît, asseyez-vous."
...
translate french d11s04_c55aeb3d:
    ...
    "Docteur" "Mh-hm, et quand est-ce que cela se produit habituellement ?"
...
translate french d11s04_b8f49847:
    ...
    "Docteur" "Depuis quand cela se produit-il ?"
...
translate french d11s04_951ef747:
    ...
    "Docteur" "Hm, cela fait donc un moment que ça dure. Pourquoi avez-vous mis autant de temps à le faire diagnostiquer ?"
...
translate french d11s04_c77adea2:
    ...
    "Docteur" " *Soupir* Je comprends. Il pourrait s'agir d'une syncope vaso-vagale, mais cela pourrait indiquer une maladie plus grave."

# game/code/d11/d11s04.rpy:179
translate french d11s04_6fbe3881:

    # "Doctor" "It is good that you are getting this checked out."
    "Docteur" "C'est une bonne chose que vous fassiez vérifier cela."
...
translate french d11s04_ad012e85:
    ...
    "Docteur" "Avez-vous des antécédents familiaux de complications cardiaques ? Des parents ? Des grands-parents ?"
...
translate french d11s04_ad90cd10:
    ...
    "Docteur" "Effectuons quelques tests."
...
translate french d11s04_0871a1ab:
    ...
    "Docteur" "Êtes-vous un ami ou un parent ?"
...
translate french d11s04_7a6f5f89:
    ...
    "Docteur" "Comme je l'ai dit, je ne peux pas le dire maintenant."
...
translate french d11s04_83e10738:
    ...
    "Docteur" "Si cela vous convient mieux, nous pouvons le programmer un autre jour."
...
translate french d11s04_42993f78:
    ...
    "Docteur" "Mais compte tenu de la gravité de la situation, je conseille de faire ces tests le plus tôt possible."
...
translate french d11s04_59365cc1:
    ...
    "Docteur" "D'accord. Nous allons préparer une chambre pour vous et nous assurer que vous êtes à l'aise."
...
translate french d11s04_83515733:
    ...
    "Docteur" "Et ne vous inquiétez pas, la nourriture de l'hôpital n'est pas aussi mauvaise que la télévision le laisse entendre."
...
translate french d11s04_d3cbd413:
    ...
    "Docteur" "Vous devriez aller attendre dans la zone de réception pour le moment. Nous vous appellerons lorsque nous serons prêts à vous accueillir."
...
translate french d11s04_b3282b2e:
    ...
    "Docteur" "Non, je suis désolée. Après les heures de visite, vous devrez partir."

# game/code/d11/d11s04.rpy:285
translate french d11s04_638d4f3f:

    # "Doctor" "But you can pick her up tomorrow."
    "Docteur" "Mais vous pouvez venir la chercher demain."
