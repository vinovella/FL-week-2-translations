...
translate french d10s05_1f1b5d28:
    ...
    mc "Alors pourquoi sommes-nous ici ?"
...
translate french d10s05_16f8af1b:
    ...
    sy "Est-ce un magasin normal qui vend des produits fétichistes ?"
...
translate french d10s05_1862ac48:
    ...
    mc "C'est plutôt cool, je suppose. Mais auront-ils quelque chose pour moi ? On dirait que beaucoup de choses ici sont destinées aux femmes."
...
translate french d10s05_6e668ae1:
    ...
    arj "Oui, c'est principalement destiné aux femmes, mais j'ai vu aussi de bonnes choses pour les hommes."
...
translate french d10s05_7f5d804e:
    ...
    arj "Honnêtement, cet endroit est génial. Comprenez ceci, les employés ne vous dérangent pas ici !"
...
translate french d10s05_9fe69540:
    ...
    mc "Cela ne veut-il pas dire que les employés sont tout simplement paresseux ?"
...
translate french d10s05_8118f02e:
    ...
    arj "Ou cela pourrait signifier qu'ils ont finalement réalisé que personne ne veut être dérangé pendant qu'ils choisissent quelque chose."
...
translate french d10s05_51bfaa27:
    ...
    arj "Oui, j'ai vu l'endroit en me promenant et j'ai décidé de voir de quoi il s'agissait. J'ai vu le costume de femme de chambre et il était parfait, alors je l'ai acheté."
...
translate french d10s05_51a670b6:
    ...
    arj "De toute façon, à quand remonte la dernière fois que tu as acheté de nouveaux vêtements ?"
...
translate french d10s05_f3e2d7f4:
    ...
    sy "Ça fait plaisir de voir qu'il n'a pas changé du tout depuis son arrivée à l'université."
...
translate french d10s05_6a72b46c:
    ...
    sy "Woah, tu vas certainement sauver la planète, [mcname]."
...
translate french d10s05_032ef49f:
    ...
    sy "Bruno ? Jamais entendu parler de cette marque. Cependant, ce n’est pas comme si j’avais déjà acheté des vêtements fétichistes auparavant."
...
translate french d10s05_a53b37b1:
    ...
    sy "Mais Bruno, quand même ? C'est quel genre de nom, d'ailleurs ?"

# game/code/d10/d10s05.rpy:110
translate french d10s05_813176bd:

    # arj "Maybe it was founded by somebody named Bruno?"
    arj "Peut-être a-t-elle été fondée par un certain Bruno ?"
...
translate french d10s05_86addca0:
    ...
    sy "C'est quoi, une sorte de champion russe des poids lourds devenu créateur de mode fétichiste ?"
...
translate french d10s05_0ea7c3e0:
    ...
    arj "Si Caline Kalin peut mettre son nom sur des sous-vêtements, je ne sais pas pourquoi le pauvre vieux Bruno ne peut pas mettre son nom dessus."
...
translate french d10s05_55f815fd:
    ...
    sy "Il faut des noms bizarres et excentriques pour créer des marques de vêtements, je suppose."
...
translate french d10s05_f9a3b9a3:
    ...
    sy "Cependant, dans le cas de Caline Kalin, on pourrait penser qu'il fabriquerait plutôt du matériel d'escalade extrême."

# game/code/d10/d10s05.rpy:123
translate french d10s05_362276a4:

    # arj "Caline Kalin's climbing gear!"
    arj "Le matériel d'escalade de Caline Kalin !"
...
translate french d10s05_34219f28:
    ...
    mc "Il doit y avoir un juste milieu entre quoi que ce soit et un mankini."
...
translate french d10s05_d7c2e112:
    ...
    arj "Eh bien, peut-être aimeriez-vous y aller en tant qu'infirmière belle et sexy, monsieur ?"
...
translate french d10s05_38a0c0e8:
    ...
    sy "Je suis sûr que Monsieur Bruno a veillé à ce qu'il soit confortable pour les hommes aux sensibilités délicates."
...
translate french d10s05_18df8def:
    ...
    mct "Ils semblent s'être vraiment bien entendus. Je suis content pour eux, je suppose."
...
translate french d10s05_ed235f64:
    ...
    mct "Je n'ai pas vraiment eu le temps de m'entraîner ou quoi que ce soit ces derniers temps, avec tous les trucs de Fetish Locator."
...
translate french d10s05_replay_7a1c514c:
    ...
    mc "Ah ! Bon Dieu, Stacy, qu'est-ce que c'est ? Ne me surprends pas comme ça ! Et qu'est-ce que tu fais ici ? Cet endroit a probablement des caméras partout."
...
translate french d10s05_replay_4769afa3:
    ...
    mc "Qu’en est-il des caméras peu évidentes alors ?"
...
translate french d10s05_replay_717e7a58:
    ...
    sy "Je lui ai dit que j'allais aux toilettes."
...
translate french d10s05_replay_a5084da6:
    ...
    mc "Waouh, qu'est-ce que tu fais ?"
...
translate french d10s05_replay_6aaabe84:
    ...
    mc "Eh bien, plus maintenant, je suppose."
...
translate french d10s05_replay_91adebd6:
    ...
    mc "Mais je n’ai pas encore pu sélectionner de pantalon. Il est inutile-"
...
translate french d10s05_replay_71ca7ce8:
    ...
    sy "Je veux aller à la fête avec vous deux. Cela a l'air amusant."
...
translate french d10s05_replay_ed1346cd:
    ...
    sy "Pourquoi tu fais comme si je te demandais de divulguer les codes nucléaires ou quelque chose comme ça ?"

# game/code/d10/d10s05.rpy:247
translate french d10s05_replay_69c5dbde:

    # sy "I just want to go to the party with you two."
    sy "Je veux juste aller à la fête avec vous deux."
...
translate french d10s05_replay_2af86f2b:
    ...
    sy "...D'accord, quand peux-tu me le dire alors ?"
...
translate french d10s05_replay_b1c74c71:
    ...
    sy "[mcname]...Tu n'es jamais comme ça, est-ce que tout va bien ?"
...
translate french d10s05_replay_7dc7e123:
    ...
    ir "Je n'ai pas besoin d'être dorlotée, je peux prendre soin de moi !"
...
translate french d10s05_replay_572cb01a:
    ...
    sy "Très bien, très bien. Je veux une explication pour tout ça à notre retour, [mcname]."
...
translate french d10s05_replay_0aad374e:
    ...
    mc "Je ne peux pas te le dire maintenant, je suis désolé"
...
translate french d10s05_replay_f99647e3:
    ...
    ir "J'en ai marre que tu essayes de contrôler ma vie."
...
translate french d10s05_replay_21b6856e:
    ...
    hr "Iona, pour l'amour de Dieu, j'essaie juste de te protéger. Pourquoi ne vois-tu pas ça ?"
...
translate french d10s05_replay_64403e96:
    ...
    hr "Quand tu arrêteras de te lancer dans des conneries encore plus stupides comme celle-là."
...
translate french d10s05_replay_ec59c066:
    ...
    ir "C'est une fête costumée, putain ! Je n'irai pas à Jonestown moi-même."
...
translate french d10s05_replay_c1e81c75:
    ...
    ir "Oh mon Dieu, s'il te plaît, arrête."
...
translate french d10s05_replay_3124b11b:
    ...
    hr "C'est juste que je ne veux pas que tu fasses quoi que ce soit avec cette application."
...
translate french d10s05_replay_cf409fc3:
    ...
    ir "C'est une application pour rencontrer des gens et s'amuser, bon sang."
...
translate french d10s05_replay_b7bbc4e8:
    ...
    ir "C'est Cinder sans tous les préliminaires stupides consistant à agir comme si vous vous intéressiez l'un à l'autre alors que vous savez tous les deux que tout le monde n'est là que pour en avoir."

# game/code/d10/d10s05.rpy:396
translate french d10s05_replay_17587ac1:

    # ir "What's so bad about that?"
    ir "Qu'est-ce qu'il y a de si grave là-dedans ?"
...
translate french d10s05_replay_c0d74915:
    ...
    ir "Désolé si je ne me souviens pas de toutes vos théories du complot farfelues."
...
translate french d10s05_replay_9e59a9c9:
    ...
    mc "Il y avait ce gros mur qui bloquait tout le spectacle. Les organisateurs ont vraiment raté la balle sur ce coup-là."
...
translate french d10s05_replay_0434e9be:
    ...
    mc "Cela dépend de ce que c'est."
...
translate french d10s05_replay_83a3a729:
    ...
    hr "L'autre fille qui vient de sortir en trombe, c'est ma sœur."
...
translate french d10s05_replay_db5e12bd:
    ...
    hr "L'autre fille qui vient de sortir en trombe, c'est ma petite amie."
...
translate french d10s05_replay_fae40d28:
    ...
    hr "Très bien, dans ce cas, peux-tu voir si tu peux garder un œil sur elle ?"
...
translate french d10s05_replay_a16788ca:
    ...
    mc "Tu veux que je sois son garde du corps ?"
...
translate french d10s05_replay_8e042165:
    ...
    mc "Eh bien, je ne vais pas traquer la fille toute la nuit et la surveiller en hélicoptère, mais si je vois quelque chose, bien sûr, je suppose."
...
translate french d10s05_replay_3df311b7:
    ...
    hr "Oh, au fait, as-tu réussi à ouvrir l'ordinateur portable de Pete ?"
...
translate french d10s05_replay_63e001dc:
    ...
    mc "Non, rien pour l'instant. J'ai mis du temps à ne pas déclencher d'alarme ou quoi que ce soit. Je me sens toujours bizarre de faire ça, tu sais."
...
translate french d10s05_replay_a9a81f6e:
    ...
    hr "Je suis sûr que tout cela va disparaître quand tu trouveras ce qu'il y a dedans."
...
translate french d10s05_replay_c448c8f3:
    ...
    mc "Très bien, à plus tard. Et je vais essayer de garder un oeil sur ta sœur."
...
translate french d10s05_replay_9b1c1bb9:
    ...
    mc "Très bien, à plus tard. Et je vais essayer de garder un oeil sur ta petite amie."
...
translate french d10s05_replay_10133eb2:
    ...
    ir "Tu as l'air différent, est-ce qu'il s'est passé quelque chose pendant mon absence ?"

# game/code/d10/d10s05.rpy:475
translate french d10s05_replay_5f7e2877:

    # hr "I got some protection for you for the party."
    hr "J'ai une protection pour toi pour la fête."
...
translate french d10s05_replay_936df8a6:
    ...
    hr "J'ai demandé à quelqu'un de s'occuper de toi."
...
translate french d10s05_replay_7e1c4671:
    ...
    hr "Il ne va pas te suivre partout ou quoi que ce soit, il va juste t'aider si quelque chose arrive."
...
translate french d10s05_replay_1b4215e7:
    ...
    hr "Au moins, je sais qu'il ne te fera probablement pas de mal."
...
translate french d10s05_replay_3cee31ed:
    ...
    hr "Hé, bien sûr. Mais tu sais que je seulement..."
...
translate french d10s05_replay_55ba978a:
    ...
    sy "Aucune idée. Je voulais détourner le regard, mais je ne pouvais pas. C'était comme si j'étais transpercé. Et je n'ai toujours pas encore parcouru toute sa collection !"
...
translate french d10s05_replay_5e8fc26b:
    ...
    mct "Oh mon Dieu, elle va utiliser ma collection porno contre moi jusqu'au jour de ma mort, hein ?"
...
translate french d10s05_replay_56d99367:
    ...
    arj "Il a peut-être l'air d'un gars assez normal de l'extérieur, mais c'est un vrai dégénéré quand les lumières sont éteintes, hein ?"

# game/code/d10/d10s05.rpy:517
translate french d10s05_replay_24e0ee82:

    # mct "Look who's talking..."
    mct "Regardez qui parle..."
...
translate french d10s05_replay_14bb84b3:
    ...
    sy "Et je suis sûr que vous ne trouverez rien, car de toute façon, qui a des collections pornographiques de nos jours ? Tes méthodes dépassées ne fonctionneront pas sur moi, grand-père."
...
translate french d10s05_replay_c31f7db1:
    ...
    mc "Si jamais j'ai besoin d'un autre costume, je trouverai le mien dans un magasin fétichiste discret."
...
translate french d10s05_replay_c9d84c97:
    ...
    sy "Je suis sûr que vous ferez parler de la fête."
...
translate french d10s05_replay_bdfef045:
    ...
    arj "Hé, on peut prendre un café avant de rentrer ?"
...
translate french d10s05_replay_9d2e92e0:
    ...
    sy "En fait, je pense que je vais juste retourner à mon appartement. Il y a encore beaucoup de choses à faire là-bas, et j’ai hâte de m’y mettre directement."
...
translate french d10s05_replay_a7d4b58c:
    ...
    sy "Je monopolise aussi un peu AmRose depuis un moment maintenant, allez-y tous les deux et prenez un café."
...
translate french d10s05_replay_3edd00c6:
    ...
    sy "Prenez garde, vous deux ! Ne t'amuse pas trop sans moi maintenant."
...
translate french d10s05_replay_b66b119e:
    ...
    fl "Vous avez obtenu [d10s05_fl_points] points."
...
translate french d10s05_replay_a1ad1b96:
    ...
    arj "Elle doit être vraiment excitée à l'idée de se mettre au travail dans son appartement."
...
translate french d10s05_replay_b69d0ed5:
    ...
    arj "Oh ouais, je pense qu'elle m'a aussi mentionné quelque chose comme ça."
