...
translate turkish prologue_fresh_start_4063ae17:
    ...
    "Merhaba ve Fetish Locator'a hoş geldiniz."

# game/code/d08/prologue.rpy:64
translate turkish prologue_fresh_start_1b390ae3:
    ...
    "Bu görsel romanın ikinci bölümünde, genç bir üniversite öğrencisi olarak oynamaya devam edecek ve şehrin en ateşli kadınlarıyla aşk, şehvet ve cinsel fetişleri keşfedeceksiniz."
...
translate turkish prologue_fresh_start_cbd04ca6:
    ...
    "Lydia'nın özellikle nesini seviyorsun?"
...
translate turkish prologue_fresh_start_36fcdd97:
    ...
    "İlk haftanın sonunda AmRose ile ilişkiniz beklenmedik bir hal aldı ve şimdi o:"
...
translate turkish prologue_girls_set_3_done_7582b991:
    ...
    "Femdom, ha? \n Tamam, Hanımınız şu anda vücuduna tapınmanızı emretseydi, hangi kısmına odaklanırdınız?"

# game/code/d08/prologue.rpy:198
translate turkish prologue_nora_creampie_fcd0a635:

    # "We see you like a little extra cream in your pie. Did you cum in Nora in Week One?"
    "Turtana biraz fazladan kaymak sevdiğini görüyoruz. Birinci Haftada Nora'ya boşaldın mı?"

# game/code/d08/prologue.rpy:212
translate turkish prologue_finalize_b8dc714d:

    # "Great! You're now ready to begin your second week playing Fetish Locator!"
    "Harika! Artık ikinci haftanıza Fetish Locator oynayarak başlamaya hazırsınız!"
...
translate turkish strings:
    ...
    new "Adınız nedir? (Varsayılan ad - Mike)"
    ...
    new "Ben bir beyefendiyim (fötr tüyoları)"

    # game/code/d08/prologue.rpy:163
    old "I want to dominate her"
    new "Ona hükmetmek istiyorum"

    # game/code/d08/prologue.rpy:184
    old "Her lovely tits"
    new "Onun güzel göğüsleri"

    # game/code/d08/prologue.rpy:184
    old "Her delicate pussy"
    new "Onun narin amcığı"
    ...
    new "Evet, onun içine girdim ve dışarı atıldım"
