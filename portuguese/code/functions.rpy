...
translate portuguese strings:
    ...
    new "Você pode assistir essa cena novamente na Galeria de Replay"

    # game/code/functions.rpy:123
    old "You've unlocked a new bonus content"
    new "Você desbloqueou um novo conteúdo bônus."

    # game/code/functions.rpy:154
    old "The game will replay the scene\naccording to a default playthrough"
    new "O jogo repetirá a cena\nde acordo com uma campanha padrão"
