...
translate portuguese d09s08_8cc631b8:
    ...
    lc "Acabei de revisar minhas notas de sociologia e queria ouvir sua voz. Aí ouvi."
...
translate portuguese d09s08_6bf95e6e:
    ...
    mc "Pode segurar um instante? Tenho outra ligação."
...
translate portuguese d09s08_393db29a:
    ...
    mh "Oi, [mcname]. Espero que não esteja ligando tarde demais."
...
translate portuguese d09s08_a158eefa:
    ...
    mc "Não, não. Acho que ela tá ansiosa pra se mudar pra um lugar dela."
...
translate portuguese d09s08_2d4bdcef:
    ...
    mh "Legal. Me liga amanhã e podemos nos encontrar lá - preencher o contrato, dar as chaves, etc."
...
translate portuguese d09s08_d54c5a02:
    ...
    mh "Ah, e não esquece de trazer os aluguéis do primeiro e o último mês."

# game/code/d09/d09s08.rpy:63
translate portuguese d09s08_99422566:

    # mc "Huh? Two months rent?"
    mc "Hmm? Dois meses de aluguel?"
...
translate portuguese d09s08_70c4c5e6:
    ...
    vw "Ei Sexy. Desculpa ligar tão tarde, mas tenho notícia importante."

# game/code/d09/d09s08.rpy:76
translate portuguese d09s08_c7796975:

    # mc "Hey sexy mama. Want to kill all humans?"
    mc "Oi, mamãe sexy. Quer matar todos os humanos?"
...
translate portuguese d09s08_da92c621:
    ...
    vw "Vou te mandar os detalhes. Srta. Harris vai ficar pronta com as chaves e o contrato amanhã."
...
translate portuguese d09s08_110bbe39:
    ...
    mc "Srta. Harris? Ah, sim. Lyssa. {w}Desculpa, acho que tô um pouco cansado."
...
translate portuguese d09s08_b66280e8:
    ...
    vw "Claro, você vai ter que trazer um cheque ou ordem de pagamento referente a dois meses de aluguel."
...
translate portuguese d09s08_05cf4e53:
    ...
    vw "Oi, [mcname]. Desculpa ligar tão tarde, mas tenho notícia importante."
...
translate portuguese d09s08_863cf98e_1:
    ...
    # vw "I thought you'd want to know asap. The apartment is ready."
    vw "Imaginei que gostaria de saber o mais rápido possível. O apartamento ficou pronto."
...
translate portuguese d09s08_24b24091:
    ...
    mc "Srta. Harris?{w} Ah, sim. Lyssa. Desculpa, acho que tô um pouco cansado."
...
translate portuguese d09s08_30e4d590:
    ...
    vw "Como eu disse - te mando toda a informação. Tenha uma boa noite de sono."

# game/code/d09/d09s08.rpy:121
translate portuguese d09s08_ab0ddfca:

    # mc "Thanks! You too, bye."
    mc "Valeu! Você também, tchau."
...
translate portuguese d09s08_49c92780:
    ...
    mc "Espera - eles estão mesmo numa Tour Mundial?"
...
translate portuguese d09s08_a031c500:
    ...
    lc "Sim, não sabia? Acho que estão na Finlândia nesse momento."
...
translate portuguese d09s08_0f964681:
    ...
    lc "Então... {w} quanto a amanhã. Se importa se falarmos sobre a Festa?"
...
translate portuguese d09s08_a931b031:
    ...
    mc "Sim. {w}Digo, não. Tudo bem. Não me importo em falar disso."
...
translate portuguese d09s08_c0aaaae1:
    ...
    mc "Só não sei o que dizer, ou o que eu devo sentir."
...
translate portuguese d09s08_11a09cb2:
    ...
    lc "Vou deixar fácil. Eu gostei de ouvir suas histórias sexuais ontem."
...
translate portuguese d09s08_fccb439d:
    ...
    lc "Sim. Tipo... eu gostei de ouvir elas de você."
...
translate portuguese d09s08_cdacf4f7:
    ...
    lc "Eu gosto de ouvir das coisas que você fez. {w}Até mesmo das pessoas com as quais você fez essas coisas."
...
translate portuguese d09s08_4e091378:
    ...
    lc "Quero ouvir o que você fez ou quem fodeu na Festa da semana passada."
...
translate portuguese d09s08_79f31cfe:
    ...
    lc "Vou querer ouvir o que você fez ou quem fodeu na Festa de amanhã."
...
translate portuguese d09s08_17d56721:
    ...
    lc "Mas não quero passar a noite de amanhã pensando no que está fazendo ou quem está fodendo."
...
translate portuguese d09s08_ae6abb16:
    ...
    lc "É estranho. Eu sei. Eu mesma estou tentando entender isso."
...
translate portuguese d09s08_f46c00b3:
    ...
    lc "Mas deixa eu falar assim - se você soubesse que ia acabar com uma outra garota, eu ficaria chateada."
...
translate portuguese d09s08_3ca9e0dd:
    ...
    lc "Mas se acabar com alguma outra garota e me falar, eu sentiria que confia em mim, e isso me deixaria bem feliz."

# game/code/d09/d09s08.rpy:174
translate portuguese d09s08_29bd6c63:

    # mc "That is weird but I kinda understand."
    mc "É estranho, mas eu entendo."
...
translate portuguese d09s08_d4059a9e:
    ...
    mc "Bom, acho que entendo as regras."
...
translate portuguese d09s08_a619a907:
    ...
    lc "Então, amanhã. Não quero que me fale que vai para a Festa."
...
translate portuguese d09s08_6a189cd4:
    ...
    mc "Deixa eu terminar - não vou pra Festa amanhã, mas vou ter ido pra Festa na noite antes de falarmos sobre isso na quinta."
...
translate portuguese d09s08_42fb5cd6:
    ...
    lc "Ah, lembra da Cynthia? Você trouxe um drink para ela na Festa semana passada."
...
translate portuguese d09s08_a983a9ea:
    ...
    mc "Hã? Ah, sim. Aquela que saiu na manhã seguinte pra um retiro religioso."
...
translate portuguese d09s08_98d46825:
    ...
    lc "Sim, você nunca iria acreditar no que ela andou aprontando desde que voltou..."
