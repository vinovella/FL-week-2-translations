...
translate portuguese d08s06_811c7687:
    ...
    sy "Sim, ela mandou ver naquela competição, e depois me mostrou como usar caiaque."
...
translate portuguese d08s06_dd7892b6:
    ...
    sa "Oi, meu nome é Shontae - mas vocês podem me chamar de Treinadora."
...
translate portuguese d08s06_f1926523:
    ...
    mc "Estranho. Pensei que Allison tinha bastante tempo livre."

# game/code/d08/d08s06.rpy:67
translate portuguese d08s06_c8ff4e25:

    # sa "She probably said that. I'm saying different."
    sa "Ela provavelmente falou isso. Eu estou falando o contrário."
...
translate portuguese d08s06_72a9443d:
    ...
    mct "Sinto uma oportunidade aqui."
...
translate portuguese d08s06_ebd7bb17:
    ...
    sa "Provavelmente algo relacionado à família dela. Bem, geralmente é isso."
...
translate portuguese d08s06_50320392:
    ...
    sa "Allison tem bastante talento, mas não tem motivação para se esforçar a ganhar."
...
translate portuguese d08s06_5a122a58:
    ...
    sy "Mas ela ganhou ontem. Acabou com todo mundo na competição de caiaque."
...
translate portuguese d08s06_7feb5c0d:
    ...
    sa "Eu não chamaria de vitória. Competir contra a faculdade é como brigar com crianças."
...
translate portuguese d08s06_4820d476:
    ...
    mct "Merda - provavelmente não devia falar que somos da faculdade."
...
translate portuguese d08s06_c22ce67f:
    ...
    sa "Não me entenda mal - eles provavelmente ganhariam de nós em uma competição de soletração, mas esporte?"
...
translate portuguese d08s06_4cd714a8:
    ...
    sa "Allison não estava competindo de verdade ontem. Ela estava só \"se divertindo\"."
...
translate portuguese d08s06_ab8112cc:
    ...
    sy "O que tem de errado em se divertir? Você disse como se fosse palavrão."
...
translate portuguese d08s06_f50f4a6c:
    ...
    mc "Acho que ela quis dizer que quando você tem tanto talento quanto a Allison, você basicamente deve ao universo o seu melhor."

# game/code/d08/d08s06.rpy:105
translate portuguese d08s06_ae2ccf84:

    # sa "Yes! Exactly. {w}I'm going to use that."
    sa "Isso! Exatamente. {w}Vou usar isso."
...
translate portuguese d08s06_2e6358fb:
    ...
    mc "Fique à vontade. Você que tinha alguma coisa a ver com a família dela?"
...
translate portuguese d08s06_cb230765:
    ...
    sa "Provavelmente. Digo, não sei den ada, mas quando alguém tem tanto talento assim mas não tem motivação..."
...
translate portuguese d08s06_49cfa60c:
    ...
    sa "... talvez mamãe não abraçou ela o bastante quando era criança. Talvez o papai abraçou demais. Não sou psiquiatra."
...
translate portuguese d08s06_fd4fd416:
    ...
    sa "É que sempre parece que envolve alguma besteira familiar que a garota precisa solucionar, e não posso fazer isso no ginásio."
...
translate portuguese d08s06_6d13dbcf:
    ...
    mc "Então, você precisa de alguém de fora do ginásio que possa ajudar ela com essas coisas."

# game/code/d08/d08s06.rpy:115
translate portuguese d08s06_8c824619:

    # sa "You a shrink or something?"
    sa "E você é algum tipo de psiquiatra?"
...
translate portuguese d08s06_dac7a29f:
    ...
    mc "... poderíamos descobrir o que tá tirando a motivação dela e encorajar ela a treinar mais sério."
...
translate portuguese d08s06_3b2b5e52:
    ...
    mc "Porém, pra fazer isso, precisamos passar um tempo com a Allison. Não podemos fazer isso se ela tá sempre ocupada."
...
translate portuguese d08s06_3ea5d3b8:
    ...
    mc "Digo, obviamente estamos preocupados com os interesses da Allison."
...
translate portuguese d08s06_560334a0:
    ...
    sa "Você é um cara bem espertalhão, hein? Todos os jovens de negócio são assim como você?"
...
translate portuguese d08s06_251e0c2a:
    ...
    sa "Não vou interromper o treino dela. Já é difícil o bastante manter ela numa rotina."
...
translate portuguese d08s06_cb3704d9:
    ...
    mc "E obviamente nós não íamos atrapalhar a rotina dela. É importante."
...
translate portuguese d08s06_258e9ff8:
    ...
    sa "Ah, bem, não é nada que você não poderia saber. Allison deve acabar com as aulas até as 16 hoje."
