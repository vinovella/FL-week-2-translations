...
translate spanish strings:
    ...
    new "Su segunda semana en Fetish Locator termina aquí"

    # game/code/screens/screens_fl.rpy:55
    old "Please type a name for the save file below and click save"
    new "Por favor, escriba un nombre para el archivo guardado a continuación y haga clic en guardar"

    # game/code/screens/screens_fl.rpy:63
    old "This will allow you to start week 3 without losing your progress"
    new "Esto le permitirá comenzar la tercera semana sin perder su progreso"
