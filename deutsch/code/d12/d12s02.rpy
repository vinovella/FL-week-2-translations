...
translate deutsch d12s02_e19d21b2:
    ...
    "Mysteriöse Frau" "Nach allem, was du mir angetan hast, erinnerst du dich nichtmal an mich?"
...
translate deutsch d12s02_abe22177:
    ...
    "Mysteriöse Frau" "Vielleicht erinnerst du dich daran, sich an einer hilflosen Frau vor ein paar Tagen vergriffen zu haben?"

# game/code/d12/d12s02.rpy:79
translate deutsch d12s02_c832bcf4:

    # "Mysterious Woman" "Maybe that jogged your mind a little?"
    "Mysteriöse Frau" "Klingelt da etwas bei dir?"
...
translate deutsch d12s02_0b4fc516:
    ...
    "Mysteriöse Frau" "Oh bitte, gib mir nicht diesen Bullshit. Glaubst du ernsthaft, dass ich nicht meine Möglichkeiten habe, jemanden zu finden, wenn ich will?"
...
translate deutsch d12s02_281c8952:
    ...
    "Mysteriöse Frau" "Wie auch immer. Du musst dich um nichts kümmern. Nun, nicht, wenn du das tust, was ich sage."

# game/code/d12/d12s02.rpy:86
translate deutsch d12s02_d5023dd3:

    # "Mysterious Woman" "Our...\"mutual friend\" gave me your number."
    "Mysteriöse Frau" "Unsere...\"gemeinsame Freundin\" hat mir deine Nummer gegeben."
...
translate deutsch d12s02_12ed7df1:
    ...
    "Mysteriöse Frau" "Wie auch immer. Du musst dich um nichts sorgen."
...
translate deutsch d12s02_389fe0a5:
    ...
    "Mysteriöse Frau" "Komm in den Gerichtssaal. Ich bin sicher, du findest den Weg."
...
translate deutsch d12s02_63e987e9:
    ...
    mct "*Seufz* Ich brauche das jetzt nicht. Ich muss mich erst auf Hana fokussieren."
...
translate deutsch d12s02_5bd4c850:
    ...
    mc "Ich wollte früher etwas einrichten, aber äh, es hat ein bisschen gedauert, um genug Selbstvertrauen zu schaffen, denke ich."

# game/code/d12/d12s02.rpy:163
translate deutsch d12s02_6d4f429e:

    # hr "Oh? You seemed confident enough at the party."
    hr "Oh? Du hast auf der Party selbstbewusst genug gewirkt."

# game/code/d12/d12s02.rpy:168
translate deutsch d12s02_69f02c1b:

    # hr "So, what happened?"
    hr "Also, was ist passiert?"
...
translate deutsch d12s02_eb012abc:
    ...
    mct "Er hat nur Fotos gekauft. Nichts mehr."
...
translate deutsch d12s02_ab314285:
    ...
    "Nichts? Fuck. Vielleicht ist er schlauer als ich dachte. Hast du überall nachgeschaut?"
...
translate deutsch d12s02_18e1cfec:
    ...
    mct "Ja. Ich habe versucht, seinen Account zu löschen. Er wurde ins Programm geschickt."
...
translate deutsch d12s02_40d409a4:
    ...
    mc "Aber ich bin ziemlich sicher, dort deine Schwester getroffen zu haben. Das war ziemlich lustig."
...
translate deutsch d12s02_ba132489:
    ...
    mc "Aber ich bin ziemlich sicher, dort deine Freundin getroffen zu haben. Das war ziemlich lustig."

# game/code/d12/d12s02.rpy:250
translate deutsch d12s02_fd92423d:

    # hr "Oh yeah. She told me about that, I think."
    hr "Oh ja. Sie hat mir, glaube ich, davon erzählt."
...
translate deutsch d12s02_178d0bfb:
    ...
    hr "Ich bin froh, dass sie sich noch daran erinnert, auf sich selbst zu achten."

# game/code/d12/d12s02.rpy:276
translate deutsch d12s02_514f59f9:

    # hr "I'd be even more worried about her going if not for that."
    hr "Ich wäre sonst viel besorgter, wenn sie geht."
...
translate deutsch d12s02_b7c631ea:
    ...
    hr "Man muss für sich selbst sorgen, weil niemand anderes das tun wird."

# game/code/d12/d12s02.rpy:284
translate deutsch d12s02_da4e507f:

    # "Okay. Whatever then. Give me the password."
    "Okay. Wie auch immer. Gib mir das Passwort."
...
translate deutsch d12s02_032d0df2:
    ...
    mct "Nein. Ich habe ihn genug betrogen."
...
translate deutsch d12s02_18f3dd9d:
    ...
    hr "Nichts wirklich interessantes."
...
translate deutsch d12s02_f1c57b74:
    ...
    mc "Wie sieht ein Tag im Leben von Hana so aus?"
...
translate deutsch d12s02_d0d7aba8:
    ...
    hr "Ich bin in der Stadt rumgerannt, auf der Suche nach etwas Interessantem, über das ich schreiben kann."
...
translate deutsch d12s02_7be288f1:
    ...
    hr "Vielleicht sollten wir unsere Kräfte bündeln und unser eigenes Nachrichtennetzwerk schaffen."
...
translate deutsch d12s02_9f1369a3:
    ...
    mct "Soll ich? Wenn Hana sich dafür entscheidet, wird das plus ein Fick für die Herausforderung sein."
...
translate deutsch d12s02_blitz_ce5b5a99:
    ...
    hr "Was? ich möchte nicht, dass die arme Reinigungskraft das hier erleben muss."
...
translate deutsch d12s02_end_4885ceca:
    ...
    hr "Das war schön. Wir sollten das wiederholen."
