...
translate deutsch prologue_fresh_start_b5c6b797:
    ...
    "Hier sind deine Freunde Lydia und Amber-Rose.\nLydia ist ruhig, romantisch und süß, während Amber-Rose temperamentvoll und leidenschaftlich ist.\nLerne sie besser kennen!"

# game/code/d08/prologue.rpy:80
translate deutsch prologue_fresh_start_cbd04ca6:

    # "What do you especially like of Lydia?"
    "Was gefällt dir besonders an Lydia?"

# game/code/d08/prologue.rpy:90
translate deutsch prologue_fresh_start_6907d43d:

    # "Lydia is a great singer, like her parents.\nWhich musical genre do you think it fits her better?"
    "Lydia ist eine tolle Sängerin, wie ihre Eltern.\nWelches Musikgenre passt deiner Meinung nach besser zu ihr?"

# game/code/d08/prologue.rpy:99
translate deutsch prologue_fresh_start_36fcdd97:

    # "At the end of the first week your relationship with AmRose took an unexpected turn and now she is:"
    "Am Ende der ersten Woche hat deine Beziehung zu AmRose eine unerwartete Wendung genommen und jetzt ist sie:"
...
translate deutsch prologue_girls_set_1_done_922f3b6c:
    ...
    "Stacy wird an dein College ziehen und du hast eine schöne Wohnung für sie gefunden. Die Besitzerin ist Lyssa (du wirst sie als Nächstes kennenlernen).\n\nWas schlägst du ihr vor?"
...
translate deutsch prologue_girls_set_2_done_faf3f787:
    ...
    "Ich sehe, du hast dich für die schöne Melissa "Lyssa" Harris entschieden.\nHow Wie verhältst du dich ihr gegenüber?"
...
translate deutsch strings:
    ...
    old "Classical arias"
    new "Klassische Arien"

    # game/code/d08/prologue.rpy:91
    old "Modern Pop/Rock"
    new "Moderner Pop/Rock"

    # game/code/d08/prologue.rpy:91
    old "Her parents' songs"
    new "Die Lieder ihrer Eltern"

    # game/code/d08/prologue.rpy:100
    old "Your secret girlfriend"
    new "Deine geheime Freundin"
    ...
    new "Ich möchte sie dominieren"

    # game/code/d08/prologue.rpy:171
    old "Her lovely tits"
    new "Ihre schönen Titten"

    # game/code/d08/prologue.rpy:171
    old "Her delicate pussy"
    new "Ihre zarte Muschi"
...
translate deutsch prologue_nora_creampie_fcd0a635:
    ...
    "Wie wir sehen, magst du ein bisschen mehr Sahne in deinem Kuchen. Hast du in der ersten Woche in Nora abgespritzt?"
...
translate deutsch prologue_fetishes_7bc3a4e5:
    ...
    "Es wird Zeit, deine Präferenzen zu wählen.\nMach dir keine Sorgen, wenn dein liebster Fetisch nicht aufgelistet ist: Fetisch Locator hat gerade erst begonnen!\nNimm so viele du willst und drücke \"Fertig\"."
...
# game/code/d08/prologue.rpy:69
translate deutsch prologue_fresh_start_d7ab3300:

    # "We see that you have already completed the first chapter. If you want to keep playing with all your game progress intact, open the menu, click \"Continue from week [FLSS.week.prev]\" and load a save.\nIf you experience any issue, please contact us on {a=https://discord.gg/efmQRNtFks}Discord{/a} or on {a=https://www.patreon.com/fetishlocator}Patreon{/a}."
    "Wir sehen, dass Sie das erste Kapitel bereits abgeschlossen haben. Wenn Sie mit Ihrem gesamten Spielfortschritt weiterspielen möchten, öffnen Sie das Menü, klicken Sie auf \"Weitermachen ab Woche [FLSS.week.prev]\" und Spielstand laden.\nIf wenn du ein Problem hast, kontaktiere uns bitte unter  {a=https://discord.gg/efmQRNtFks}Discord{/a} oder auf {a=https://www.patreon.com/fetishlocator}Patreon{/a}."

# game/code/d08/prologue.rpy:80
translate deutsch prologue_fresh_start_5b4c2953:
