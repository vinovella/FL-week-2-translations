...
translate italian d12s05_ab1ce2da:
    ...
    mct "Forse perché quella volta che mi sono scopato Nora, m'ha cacciato di qui."
...
translate italian d12s05_cf868d79:
    ...
    mct "Decisamente non ha gradito la mia farcitura extra."
...
translate italian d12s05_8dd56798:
    ...
    mct "Sarei stato più tranquillo, se la mia ragazza non m'avesse invitato in un posto dove mi sono bombato altre donne."
...
translate italian d12s05_d0d6f88d:
    ...
    mct "Speriamo che Nora non si faccia i cazzi di Lydia.{w} Eh, bella battuta."
...
translate italian d12s05_03640fae:
    ...
    mct "Forse dovrei buttare giù per Lydia una lista di tutte le donne che mi sono scopato: non sia mai che ne scopra una per caso."
...
translate italian d12s05_862d3374:
    ...
    mct "Oh, bene. Pare che Nora faccia finta di non avercela con me."
...
translate italian d12s05_a1ef874a:
    ...
    mc "E io che avevo pensato di averti così annoiata che fossi caduta addormentata."

# game/code/d12/d12s05.rpy:204
translate italian d12s05_32c134cb:

    # nk "Ha! {w}sorry, pretend I'm not here."
    nk "Ah!{w} Scusate, fate finta che non ci sia."
...
translate italian d12s05_1fc2458a:
    ...
    mct "Ha fatto presto.{w} Pensavo che le ragazze ci mettessero un'eternità per incipriarsi il naso."
...
translate italian d12s05_part2_820faca2:
    ...
    lc "Beh, so che ti piacciono i film del passato... D'altro canto io adoro i musical, così..."
...
translate italian d12s05_part2_f988d2dd:
    ...
    mct "Oh no! Mi toccherà sorbirmi \"Hello, Dolly!\" o qualcosa del genere."
...
translate italian d12s05_part2_63ed7a36:
    ...
    lc "Ho pensato che \"Brillantina\" sarebbe stato il film perfetto per noi da guardare insieme!"

# game/code/d12/d12s05.rpy:297
translate italian d12s05_part2_acb54a85:

    # mct "Well, that's unexpected."
    mct "Beh, questa non me l'aspettavo."
...
translate italian d12s05_part2_a37a577e:
    ...
    mc "Beh, i film di Patrick Swayze mi piacciono."
...
translate italian d12s05_part2_2dbcd2c7:
    ...
    mc "Ma \"Brillantina\" è decisamente meglio da vedere al cinema."

# game/code/d12/d12s05.rpy:316
translate italian d12s05_part2_3448432f:

    # lc "Oh! {w}Maybe we can watch the other film sometime."
    lc "Oh!{w} Forse allora un'altra volta possiamo vedere anche l'altro film."
...
translate italian d12s05_part2_6c257185:
    ...
    mc "È stato quando ti ho detto che stavo con Allison sulle scale?"
...
translate italian d12s05_part2_fc4ba8ee:
    ...
    mc "È stato quando ti ho detto che l'ho messo di dietro a Cynthia?"
...
translate italian d12s05_part2_f5509921:
    ...
    mc "È stato quando ti ho detto quello che ho fatto quando mi sono appartato con Lyssa?"
...
translate italian d12s05_part2_306b2249:
    ...
    mc "È stato quando ti ho detto di Talia sulla nave pirata?"
...
translate italian d12s05_part2_eb6a0c75:
    ...
    mc "È stato quando ti ho detto quello che Dahlia mi ha fatto nella stanza di Pandora?"
...
translate italian d12s05_part2_e24a0d19:
    ...
    mc "È stato quando ti ho detto cosa ho fatto a Daisy nella stanza di Pandora?"
...
translate italian d12s05_part2_243c91a7:
    ...
    lc "Proprio così! Quel racconto è stato terribilmente ECCITANTE!{w} Non sono riuscita a trattenermi."
...
translate italian d12s05_part2_036ae085:
    ...
    lc "Tipo, oggi sei un ragazzo normale. Domani fai sesso con qualcuno."
...
translate italian d12s05_part2_f6f13374:
    ...
    lc "E poi il giorno dopo fai sesso con tre persone. E poi cinque, dieci, venti..."

# game/code/d12/d12s05.rpy:361
translate italian d12s05_part2_a0798811:

    # mct "Twenty in a long weekend is pretty difficult."
    mct "Venti in un fine settimana, per quanto lungo, non è affatto facile."
...
translate italian d12s05_part2_213533a4:
    ...
    mct "Non è che al momento io abbia il completo controllo della situazione. Ma questo non glielo posso dire... o forse sì?"
...
translate italian d12s05_part2_f7f6822d:
    ...
    mc "Capisco cosa intendi.{w} A volte mi chiedo se Fetish Locator non possa diventare una fissazione."
...
translate italian d12s05_part2_b5231666:
    ...
    lc "Lo è?{w} Ti senti come dipendente, o drogato?"
...
translate italian d12s05_part2_bea65db4:
    ...
    lc "Oh.{w} Non mi aspettavo questa risposta."
...
translate italian d12s05_part2_d2f89647:
    ...
    mc "Ma penso che una minima dipendenza possa essere un'ottima cosa, di tanto in tanto."
...
translate italian d12s05_part2_08acb59f:
    ...
    mc "Tipo come con i videogame, oppure una tesina per la scuola. Finisco per concentrarmi molto sull'obbiettivo. È utile."
...
translate italian d12s05_part2_62274acd:
    ...
    lc "Io devo imparare a farlo.{w} Mi fisso sulle cose fino al punto che sento che mi divorano."
...
translate italian d12s05_part2_a7a6d4f1:
    ...
    lc "Così ho paura di provare une cose... peggio ancora, temo di diventarne dipendente."

# game/code/d12/d12s05.rpy:381
translate italian d12s05_part2_d5e5d9d9:

    # mc "Maybe I can help you with that."
    mc "Forse in questo ti posso aiutare."
...
translate italian d12s05_part2_a1f16900:
    ...
    lc "E la tua fissazione attuale, qual è?"
...
translate italian d12s05_part2_aa01654b:
    ...
    lc "Ah!{w} Oh! Il film sta per iniziare."
...
translate italian d12s05_hjcum_844b458e:
    ...
    lc "Penso che andrò a casa a farmi una doccia."
...
translate italian d12s05_hjcum_2ba1596b:
    ...
    mc "È stato bellissimo. Grazie di tutto questo."

# game/code/d12/d12s05.rpy:474
translate italian d12s05_hjcum_2a60131d:

    # lc "I enjoyed it too."
    lc "È piaciuto molto anche a me."
...
translate italian d12s05_hjcum_fae3dd2f:
    ...
    mct "Detesto vederla andare via, ma mi piace guardarla mentre esce."

# game/code/d12/d12s05.rpy:500
translate italian d12s05_stop_96ef0c34:

    # mc "Wait. {w}Wait."
    mc "Aspetta.{w} Aspetta."
...
translate italian d12s05_stop_a750bfe9:
    ...
    mc "Va bene così.{w} Tutto quello che voglio sei tu."
...
translate italian d12s05_stop_92c98c98:
    ...
    mct "Così come sicuro di avere le palle che mi scoppiano.{w}.. ma a questo rimedierò."
...
translate italian d12s05_stop_0ba3c149:
    ...
    lc "Okay.{w} Grazie. Ti prometto che un giorno mi farò perdonare."
...
translate italian d12s05_stop_f59dbc2e:
    ...
    lc "Mi piacerebbe passare il resto della giornata con te, ma è sopraggiunto un impegno."
...
translate italian d12s05_end_a67acd13:
    ...
    dw "Da me tra 30 minuti.{w} E vedi di esserci."
