...
translate italian d14s13_7e6cdc3d:
    ...
    sy "Uh... Hana mi stava raccontando una storia e mi sono forse distratta un po'."
...
translate italian d14s13_2fd657e6:
    ...
    mc "Oh, giusto. Se in qualche modo non l'avessi capito, volevamo dirti una cosa."
...
translate italian d14s13_fc5c13b3:
    ...
    arj "Quello che sta dicendo è che stiamo cercando di distruggere FL."
...
translate italian d14s13_14c32c40:
    ...
    arj "E [mcname] ci ha parlato un po' di te. Pensavamo che saresti stata una buona aggiunta alla squadra."
...
translate italian d14s13_d7f77a7d:
    ...
    mc "Tu vuoi distruggere FL tanto quanto lo vogliamo noi, e lavorare insieme è l'unica cosa che possiamo fare a questo punto."

# game/code/d14p2/d14s13.rpy:74
translate italian d14s13_f840e339:

    # hr "...What is your game plan even?"
    hr "...E quale sarebbe il tuo piano?"
...
translate italian d14s13_d67d5397:
    ...
    mc "Beh, prima di tutto volevamo trovare un posto dover poter parlare in pace."
...
translate italian d14s13_f1cb5078:
    ...
    sy "Quindi abbiamo trasformato il mio appartamento in una gabbia di faraday. Lì non saremo rintracciabili."
...
translate italian d14s13_ea8b8cb6:
    ...
    mc "Sì. Non dovremo più svignarcela in mezzo all'oceano per parlare."
...
translate italian d14s13_ec34b552:
    ...
    arj "Beh, tra noi quattro tu sei quella che più ci è andata vicina. Hai già trovato un sacco di cose su di loro. Stavamo pensando di prenderti con noi e vedere da lì le nostre opzioni."
...
translate italian d14s13_86a23163:
    ...
    sy "Ma l'obiettivo di base generale è quello di radere al suolo Fetish Locator. Hai idea di come farlo?"

# game/code/d14p2/d14s13.rpy:89
translate italian d14s13_fd73814e:

    # hr "Have you told them about Pete?"
    hr "Gli hai raccontato di Pete?"
...
translate italian d14s13_e6c9c5f4:
    ...
    hr "Speravo di poterci ricavare qualcosa, ma non ha funzionato, quindi ad essere onesta temo di saperne quanto voi ora."
...
translate italian d14s13_0b8d7722:
    ...
    arj "Perfetto allora. Sono sicura che noi quattro riusciremo a fare qualcosa."

# game/code/d14p2/d14s13.rpy:104
translate italian d14s13_70d5b507:

    # mc "Hm. What about the updates?"
    mc "Hm. E per quanto riguarda gli aggiornamenti?"
...
translate italian d14s13_fc1c26b4:
    ...
    mc "Fetish Locator si aggiorna quasi regolarmente, no? E deve essere online per inviare le foto e le altre cose da dove cavolo le manda."

# game/code/d14p2/d14s13.rpy:112
translate italian d14s13_fbf98aa7:

    # hr "You're thinking about tracking the signal?"
    hr "Stai pensando di tracciare il segnale?"
...
translate italian d14s13_9649a8f0:
    ...
    mc "Esattamente.{w} Se tutto va bene, dovrebbe darci ciò di cui abbiamo bisogno per scoprire dove abita colui che gestisce l'app."
...
translate italian d14s13_0b770f75:
    ...
    sy "Ma questo presuppone che abbia il server in... beh, ovunque si trovi."
...
translate italian d14s13_a31fd08b:
    ...
    sy "Se sta usando qualche tipo di archivio o server remoto per costruire il programma e trasmettere gli aggiornamenti, probabilmente non riusciremo a capire chi sono le persone dietro all'app."
...
translate italian d14s13_67da7493:
    ...
    hr "Potrebbero comunque essere informazioni potenzialmente importanti. E considera che non abbiamo molti indizi da cui partire, dobbiamo raccogliere il più possibile."
...
translate italian d14s13_9ca836d9:
    ...
    sy "Hm. Giusto. Non deve essere troppo difficile avere un'app che possa fiutare da dove provengano i pacchetti in entrata e in uscita."
...
translate italian d14s13_dbbf308b:
    ...
    mc "Siamo sicuri che sia una buona idea? FL è... stranamente senziente certe volte. E se avesse una sorta di misura di sicurezza che la blocca o peggio quando qualcuno cerca di curiosare in giro?"
...
translate italian d14s13_a049b238:
    ...
    arj "Io posso creare qualcosa che possa recuperare i pacchetti esternamente. Questo ci direbbe tutto ciò che dobbiamo sapere, e FL non sarebbe più saggio."

# game/code/d14p2/d14s13.rpy:129
translate italian d14s13_55a7f681:

    # sy "Ooh, and I can help with the software side of things!"
    sy "Ooh, e io posso aiutare con il software!"

# game/code/d14p2/d14s13.rpy:131
translate italian d14s13_2b1009fe:

    # arj "That'd be great!"
    arj "Sarebbe fantastico!"
...
translate italian d14s13_7ce556a8:
    ...
    hr "Sembra che abbiamo un piano. Nel frattempo io cercherò di capire il più possibile."
...
translate italian d14s13_3f33e4ec:
    ...
    hr "Sarò sincera, quando [mcname] non ha trovato niente nel laptop di Pete mi sono scoraggiata un po'."
...
translate italian d14s13_a892bbc5:
    ...
    hr "Ma con voi due, potremmo arrivare da qualche parte." 
...
translate italian d14s13_8edce6a2:
    ...
    mc "E io cercherò di non perdere il mio cazzo e di aiutare come posso."
...
translate italian d14s13_ddd03b4b:
    ...
    sy "Mi piacerebbe potermi scopare 20 persone e chiamarlo lavoro. Avrei il lavoro migliore tra noi quattro."
