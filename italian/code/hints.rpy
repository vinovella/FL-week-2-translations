...
translate italian strings:
    ...
    new "Attualmente questa scelta non ha alcuna grande conseguenza."
    ...
    # game/code/hints.rpy:5
    old "Wrong answer."
    new "Risposta sbagliata."

    # game/code/hints.rpy:5
    old "Right answer."
    new "Risposta corretta."

    # game/code/hints.rpy:5
    old "This choice doesn't have any great consequence currently - You will bend the knee either way."
    new "Attualmente questa scelta non ha alcuna grande conseguenza - Ti inginocchierai in ogni caso."
    ...
    new "Attualmente questa scelta non ha alcuna grande conseguenza - Crudele."

    # game/code/hints.rpy:5
    old "Takes you to the end of the scene."
    new "Ti porta alla fine della scena."

    # game/code/hints.rpy:5
    old "Lyssa gives you a blowjob."
    new "Lyssa ti fa un pompino."
    ...
    new "Ti salterai il divertimento con Samiya."

    # game/code/hints.rpy:5
    old "You will have some fun with Samiya."
    new "Ti divertirai un po’ con Samiya."
    ...
    new "In futuro ti divertirai con Vanessa in pubblico."
    ...
    new "Scegli questa opzione se vuoi essere una persona strana e non ottenere il maggior numero di punti."
    ...
    new "Scegli questa opzione e continua a scegliere la terza opzione se vuoi sembrare uno psicopatico di fronte a Lydia e ottenere il maggior numero di punti."

    # game/code/hints.rpy:5
    old "Pick this if you want to not look like a psycho in front of Lydia and get the highest number of points."
    new "Scegli questa opzione se non vuoi sembrare uno psicopatico di fronte a Lydia e ottenere il maggior numero di punti."

    # game/code/hints.rpy:5
    old "The scene will progress as usual."
    new "La scena procederà normalmente."

    # game/code/hints.rpy:5
    old "You will get bailed out and get the option to do something else for Samiya."
    new "Verrai rilasciato su cauzione e avrai la possibilità di fare qualcos’altro per Samiya."

    # game/code/hints.rpy:5
    old "Samiya will dominate you."
    new "Samiya ti dominerà."

    # game/code/hints.rpy:5
    old "You will dominate Samiya."
    new "Dominerai Samiya."

    # game/code/hints.rpy:5
    old "You drink Squizzle's piss straight from the tap."
    new "Berrai la pipì di Squizzle direttamente dalla fonte."
    ...
    new "Ti stuprerai la Giudice e otterrai una Stella d’Oro."

    # game/code/hints.rpy:5
    old "You will bail out and you will have to do something else for Samiya."
    new "Ti tirerai fuori e dovrai fare qualcos’altro per Samiya."

    # game/code/hints.rpy:5
    old "You will face fuck the Judge."
    new "Metterai il cazzo in bocca alla Giudice."

    # game/code/hints.rpy:5
    old "You will skull fuck the Judge."
    new "Metterai con forza il cazzo in bocca alla Giudice."

    # game/code/hints.rpy:5
    old "You will go on to fuck the Judge."
    new "Continuerai a scoparti la Giudice."

    # game/code/hints.rpy:5
    old "You will fuck the Judge."
    new "Ti scoperai la Giudice."

    # game/code/hints.rpy:5
    old "You will creampie the Judge and the scene will end."
    new "Verrai dentro la Giudice e la scena si concluderà."

    # game/code/hints.rpy:5
    old "You will flip the Judge over and fuck her that way."
    new "Girerai la Giudice e te la scoperai in quel modo."
    ...
    new "Continuerai a strusciare il cazzo contro quello di Lyssa."

    # game/code/hints.rpy:5
    old "The scene will end."
    new "La scena si conclude."
    ...
    new "Questa è una scelta importante che cambia il modo in cui si sviluppa la tua relazione con Oliver – Andrai a parlare con Oliver."
    ...
    new "Questa è una scelta importante che cambia il modo in cui si sviluppa la tua relazione con Oliver – Si aprirà l’arco di Oliver."

    # game/code/hints.rpy:5
    old "You will fuck Cynthia's ass."
    new "Ti scoperai Cynthia in culo."

    # game/code/hints.rpy:5
    old "You will walk away from the holy ass - You will miss some future content with Cynthia because of this."
    new "Ti allontanerai dal santo culo – In questo modo ti perderai alcuni contenuti futuri con Cynthia."

    # game/code/hints.rpy:5
    old "You will keep watching Chloe get throat fucked by Antony."
    new "Continuerai a guardare Chloe che viene scopata in bocca da Antony."
    ...
    new "Continuerai a guardare Chloe che viene scopata in bocca e poi vomita."
    ...
    new "Questa è una scelta importante che cambia il modo in cui si sviluppa la tua relazione con Jessie - \"Cavalcherai\" Jessie in diversi modi - Se non vai si chiuderà il suo arco."

    # game/code/hints.rpy:5
    old "You will skip any remaining events and prepare for the main event with Allison and Squizzle."
    new "Salterai tutti gli eventi rimanenti e ti preparerai all’evento principale con Allison e Squizzle."

    # game/code/hints.rpy:5
    old "You'll intervene and piss off Iona."
    new "Interverrai e farai incazzare Iona."
    ...
    new "Questa è una scelta importante che cambia il modo in cui si sviluppa la tua relazione con Daisy - Se non vai si chiuderà il suo arco."
    ...
    new "Accarezzerai il suo culo e la sua figa."

    # game/code/hints.rpy:5
    old "You won't take advantage of Daisy's precarious position."
    new "Non approfitterai della posizione precaria di Daisy."

    # game/code/hints.rpy:5
    old "You spank Daisy's ass with your hand."
    new "Sculaccerai il culo di Daisy."

    # game/code/hints.rpy:5
    old "You will paddle Daisy's ass with the paddle"
    new "Sculaccerai il culo di Daisy con la racchetta"

    # game/code/hints.rpy:5
    old "You will cane Daisy's ass with the sticks."
    new "Sculaccerai il culo di Daisy con le bacchette."

    # game/code/hints.rpy:5
    old "You cum, but you miss the chance to stand Daisy up and fuck her that way."
    new "Tu vieni, ma perdi l’occasione di alzare Daisy e di scoparla in quel modo."

    # game/code/hints.rpy:5
    old "You'll stand Daisy up and fuck her that way."
    new "Alzerai Daisy e te la scoperai in quel modo."

    # game/code/hints.rpy:5
    old "You will paddle Daisy's tits."
    new "Schiaffeggerai le tette di Daisy."

    # game/code/hints.rpy:5
    old "You don't paddle Daisy's tits."
    new "Non schiaffeggerai le tette di Daisy."

    # game/code/hints.rpy:5
    old "You cum, but you miss the chance to fuck Daisy doggy style."
    new "Tu verrai, ma ti perderai l’occasione di scoparti Daisy a pecora."

    # game/code/hints.rpy:5
    old "You'll turn Daisy around and fuck her doggy style."
    new "Girerai Daisy e te la scoperai a pecora."

    # game/code/hints.rpy:5
    old "You cum, but you miss the chance to fuck Daisy's mouth."
    new "Tu verrai, ma ti perderai l’occasione di scoparti Daisy in bocca."

    # game/code/hints.rpy:5
    old "You'll switch to Daisy's mouth and cum down her throat."
    new "Metterai il cazzo in bocca a Daisy e le verrai in gola."
    ...
    new "Questa è una scelta importante che cambia il modo in cui si sviluppa la tua relazione con Dahlia – Se non ti sottometti si chiuderà il suo arco."

    # game/code/hints.rpy:5
    old "This is an important choice that changes the way your relationship with Dahlia develops - You will submit to Dahlia."
    new "Questa è una scelta importante che cambia il modo in cui si sviluppa la tua relazione con Dahlia – Ti sottometterai a Dahlia."

    # game/code/hints.rpy:5
    old "You will get hard and Dahlia will slap your dick."
    new "Ti verrà duro e Dahlia ti schiaffeggerà il cazzo."

    # game/code/hints.rpy:5
    old "You won't get hard and Dahlia will make you to suck a dildo."
    new "Non ti verrà duro e Dahlia ti farà succhiare un dildo."
    ...
    new "Non ti verrà duro."

    # game/code/hints.rpy:5
    old "You will take the whole dildo in."
    new "Ti prenderai tutto il dildo dentro."
    ...
    new "Vedrai AmRose ingoiare il tuo sperma."

    # game/code/hints.rpy:5
    old "You won't get any cum garnish content."
    new "Non otterrai alcun contenuto guarnito di sperma."
    ...
    new "La bacerai mentre ha il tuo sperma in bocca."

    # game/code/hints.rpy:5
    old "You'll kiss AmRose on the neck."
    new "Bacerai AmRose sul collo."

    # game/code/hints.rpy:5
    old "You'll see squirting action in the future."
    new "In futuro vedrai un po’ di squirting."

    # game/code/hints.rpy:5
    old "You won't see any squirting action in the future."
    new "In futuro non vedrai alcuno squirting."

    # game/code/hints.rpy:5
    old "You'll get pictures of what Maria does with Terrell."
    new "Riceverai delle foto di cosa fa Maria con Terrell."

    # game/code/hints.rpy:5
    old "You won't see what Maria does with Terrell."
    new "Non vedrai cosa fa Maria con Terrell."

    # game/code/hints.rpy:5
    old "You tell her that you put Pete into the retention program."
    new "Le dirai che hai inserito Pete nel programma di fidelizzazione."

    # game/code/hints.rpy:5
    old "You don't tell her that you put Pete into the retention program."
    new "Non le dirai che hai inserito Pete nel programma di fidelizzazione."
    ...
    new "Non ti scopi Hana."

    # game/code/hints.rpy:5
    old "You'll take the Judge's deal and \"rape\" her again."
    new "Accetti l’offerta della Giudice e la \"stuprerai\" di nuovo."

    # game/code/hints.rpy:5
    old "You won't take the Judge's deal and she won't do anything to you."
    new "Non accetti l’offerta della Giudice e lei non ti farà niente."

    # game/code/hints.rpy:5
    old "You'll give Lyssa a blowjob."
    new "Farai un pompino a Lyssa."

    # game/code/hints.rpy:5
    old "You won't give Lyssa a blowjob."
    new "Non farai un pompino a Lyssa."
    ...
    new "Studierai duramente per gli esami in modo da non essere bocciato."
    ...
    new "Non innescherai l’evento Lampo."
    ...
    new "Vanessa pulisce lo sperma dalle scarpe."

    # game/code/hints.rpy:5
    old "Vanessa will wear the cum covered shoe later."
    new "Vanessa indosserà le scarpe coperte di sperma."

    # game/code/hints.rpy:5
    old "You will fist Polly's ass."
    new "Metterai un pugno nel culo di Polly."

    # game/code/hints.rpy:5
    old "The scene will stop."
    new "La scena si concluderà."

    # game/code/hints.rpy:5
    old "Stay feeds it to you."
    new "Stacy te lo dà da mangiare."

    # game/code/hints.rpy:5
    old "Stacy puts it on your dick and AmRose eats off of it."
    new "Stacy lo metterà sul tuo cazzo e AmRose se lo mangerà."
    ...
    new "La sconfiggerai e te la scoperai in culo."

    # game/code/hints.rpy:5
    old "Samiya wins and fucks you with a strap-on."
    new "Samiya vince e ti scopa con uno strap-on."
